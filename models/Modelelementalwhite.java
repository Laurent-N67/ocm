...
public static class Modelelementalwhite extends ModelBase {
	...
	public Modelelementalwhite() {
		...
		arm1.setRotationPoint(0.0F, -3.0F, 7.0F);
		arm1.cubeList.add(new ModelBox(arm1, 26, 26, -3.0F, -1.0F, 0.0F, 7, 17, 6, 0.0F, false));

		arm2 = new ModelRenderer(this);
		arm2.setRotationPoint(0.0F, -3.0F, -7.0F);
		arm2.cubeList.add(new ModelBox(arm2, 0, 25, -3.0F, -1.0F, -6.0F, 7, 17, 6, 0.0F, false));
		...
		bb_main.cubeList.add(new ModelBox(bb_main, 0, 0, -5.0F, -28.0F, -6.0F, 11, 13, 12, 0.0F, false));
	}
	...
	public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5, Entity e) {
		...
		this.turn1.rotateAngleZ = f2 / 20.f;
