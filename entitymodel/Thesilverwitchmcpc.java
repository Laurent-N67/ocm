...
public class Thesilverwitchmcpc extends EntityModel<Entity> {
	...
	public Thesilverwitchmcpc() {
		...
		cube_r1.setRotationPoint(-2.0F, 21.4F, 9.0F);
		head.addChild(cube_r1);
		setRotationAngle(cube_r1, 0.256F, 0.2969F, 0.0462F);
		cube_r1.setTextureOffset(42, 7).addBox(1.7339F, -28.5493F, -6.8595F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		cube_r1.setTextureOffset(42, 7).addBox(2.7339F, -28.5493F, -6.8595F, 1.0F, 2.0F, 1.0F, 0.0F, false);
		cube_r1.setTextureOffset(42, 7).addBox(3.7339F, -28.5493F, -6.8595F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		cube_r1.setTextureOffset(42, 7).addBox(0.7339F, -28.5493F, -6.8595F, 1.0F, 3.0F, 1.0F, 0.0F, false);
		cube_r1.setTextureOffset(42, 7).addBox(-0.2661F, -28.5493F, -6.8595F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		cube_r1.setTextureOffset(42, 7).addBox(6.7339F, -27.5493F, -6.8595F, 1.0F, 4.0F, 1.0F, 0.0F, false);
		cube_r1.setTextureOffset(43, 9).addBox(-0.2661F, -24.5493F, -6.8595F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		cube_r1.setTextureOffset(43, 9).addBox(6.7339F, -28.5493F, -6.8595F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		cube_r1.setTextureOffset(43, 9).addBox(5.7339F, -28.5493F, -6.8595F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		cube_r1.setTextureOffset(44, 10).addBox(5.7339F, -27.5493F, -6.8595F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		cube_r1.setTextureOffset(44, 10).addBox(4.7339F, -28.5493F, -6.8595F, 1.0F, 1.0F, 1.0F, 0.0F, false);
		cube_r1.setTextureOffset(14, 8).addBox(-0.2661F, -31.5493F, -6.8595F, 8.0F, 3.0F, 1.0F, 0.0F, false);
		cube_r1.setTextureOffset(0, 0).addBox(-0.2661F, -31.5493F, -5.8595F, 8.0F, 8.0F, 8.0F, 0.0F, false);
		cube_r1.setTextureOffset(32, 0).addBox(-0.2661F, -31.5493F, -5.8595F, 8.0F, 8.0F, 8.0F, 0.0F, false);
