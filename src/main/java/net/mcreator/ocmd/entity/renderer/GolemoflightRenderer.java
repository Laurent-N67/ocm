...
@OnlyIn(Dist.CLIENT)
public class GolemoflightRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(GolemoflightEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelgolemoflight(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ocm:textures/elementalwhite.png");
					}
				};
			});
		}
	...
	public static class Modelgolemoflight extends EntityModel<Entity> {
