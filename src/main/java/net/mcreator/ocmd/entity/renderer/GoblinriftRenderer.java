...
import net.mcreator.ocmd.entity.GoblinriftEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class GoblinriftRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(GoblinriftEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelgoblinstaffrift(), 0.3f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ocm:textures/goblinstaffrift.png");
					}
				};
			});
			RenderingRegistry.registerEntityRenderingHandler(GoblinriftEntity.arrow,
