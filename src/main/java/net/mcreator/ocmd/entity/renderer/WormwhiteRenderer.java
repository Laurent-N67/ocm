...
import net.mcreator.ocmd.entity.WormwhiteEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class WormwhiteRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WormwhiteEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelwormwhite(), 0.1f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ocm:textures/wormwhite.png");
					}
				};
			});
		}
	...
	public static class Modelwormwhite extends EntityModel<Entity> {
		private final ModelRenderer bb_main;

		public Modelwormwhite() {
			textureWidth = 16;
			textureHeight = 16;
