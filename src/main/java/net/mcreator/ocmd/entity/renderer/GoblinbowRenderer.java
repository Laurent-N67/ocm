...
import net.mcreator.ocmd.entity.GoblinbowEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class GoblinbowRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(GoblinbowEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelgoblinbow(), 0.3f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ocm:textures/goblinbow.png");
					}
				};
			});
			RenderingRegistry.registerEntityRenderingHandler(GoblinbowEntity.arrow,
	...
	public static class Modelgoblinbow extends EntityModel<Entity> {
