...
@OnlyIn(Dist.CLIENT)
public class ThesilverwitchRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(ThesilverwitchEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new ModelThesilverwitchmcpce(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ocm:textures/silverwitch.png");
					}
				};
			});
		}
