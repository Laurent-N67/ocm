...
import net.mcreator.ocmd.entity.WormdarkEntity;

import com.mojang.blaze3d.vertex.IVertexBuilder;
import com.mojang.blaze3d.matrix.MatrixStack;

@OnlyIn(Dist.CLIENT)
public class WormdarkRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WormdarkEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelwormdark(), 0.1f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("ocm:textures/wormdark.png");
					}
				};
			});
		}
	...
	public static class Modelwormdark extends EntityModel<Entity> {
		private final ModelRenderer bb_main;

		public Modelwormdark() {
			textureWidth = 16;
			textureHeight = 16;
