...
import net.mcreator.ocmd.entity.renderer.BlueslimeRenderer;
import net.mcreator.ocmd.OcmModElements;

@OcmModElements.ModElement.Tag
public class BlueslimeEntity extends OcmModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 1f))
					.build("blueslime").setRegistryName("blueslime");

	public BlueslimeEntity(OcmModElements instance) {
		super(instance, 152);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BlueslimeRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16751002, -16724737, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("blueslime_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("ocm:farmfrost").equals(event.getName()))
			biomeCriteria = true;
		if (new ResourceLocation("ocm:oceanfarm").equals(event.getName()))
			biomeCriteria = true;
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(BlueslimeballItem.block));
		}
