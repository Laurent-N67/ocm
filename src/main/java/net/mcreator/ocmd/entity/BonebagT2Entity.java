...
import net.mcreator.ocmd.entity.renderer.BonebagT2Renderer;
import net.mcreator.ocmd.OcmModElements;

@OcmModElements.ModElement.Tag
public class BonebagT2Entity extends OcmModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("bonebag_t_2").setRegistryName("bonebag_t_2");

	public BonebagT2Entity(OcmModElements instance) {
		super(instance, 187);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BonebagT2Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6724096, -8620691, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("bonebag_t_2_spawn_egg"));
	}
