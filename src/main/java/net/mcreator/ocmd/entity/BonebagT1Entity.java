...
import net.mcreator.ocmd.entity.renderer.BonebagT1Renderer;
import net.mcreator.ocmd.OcmModElements;

@OcmModElements.ModElement.Tag
public class BonebagT1Entity extends OcmModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("bonebag_t_1").setRegistryName("bonebag_t_1");

	public BonebagT1Entity(OcmModElements instance) {
		super(instance, 186);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BonebagT1Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10053376, -8620691, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("bonebag_t_1_spawn_egg"));
	}
