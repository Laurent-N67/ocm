...
import net.mcreator.ocmd.entity.renderer.FairyRenderer;
import net.mcreator.ocmd.OcmModElements;

import java.util.Random;

@OcmModElements.ModElement.Tag
public class FairyEntity extends OcmModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.3f, 1.5f)).build("fairy").setRegistryName("fairy");

	public FairyEntity(OcmModElements instance) {
		super(instance, 2462);
		FMLJavaModLoadingContext.get().getModEventBus().register(new FairyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -10066432, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("fairy_spawn_egg"));
	}
