...
import net.mcreator.ocmd.entity.renderer.HerobrineRenderer;
...
public class HerobrineEntity extends OcmModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("herobrine").setRegistryName("herobrine");

	public HerobrineEntity(OcmModElements instance) {
		super(instance, 197);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13379909, -13819970, new Item.Properties().group(ItemGroup.MISC))
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.ATTACK_KNOCKBACK, 8);
