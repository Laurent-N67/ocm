...
import net.mcreator.ocmd.entity.renderer.PanthereRenderer;
import net.mcreator.ocmd.OcmModElements;

@OcmModElements.ModElement.Tag
public class PanthereEntity extends OcmModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(1.1f, 1.4f)).build("panthere").setRegistryName("panthere");

	public PanthereEntity(OcmModElements instance) {
		super(instance, 170);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PanthereRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -14473163, -16250610, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("panthere_spawn_egg"));
	}
