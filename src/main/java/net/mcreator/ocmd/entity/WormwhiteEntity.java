...
import net.mcreator.ocmd.entity.renderer.WormwhiteRenderer;
import net.mcreator.ocmd.OcmModElements;

@OcmModElements.ModElement.Tag
public class WormwhiteEntity extends OcmModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.4f, 0.4f)).build("wormwhite").setRegistryName("wormwhite");

	public WormwhiteEntity(OcmModElements instance) {
		super(instance, 108);
		FMLJavaModLoadingContext.get().getModEventBus().register(new WormwhiteRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6645094, -3158065, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("wormwhite_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(WorkwhiteitemItem.block));
		}
