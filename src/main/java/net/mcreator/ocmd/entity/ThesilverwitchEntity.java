...
import net.mcreator.ocmd.procedures.ThesilverwitchQuandLentiteEstBlesseeProcedure;
import net.mcreator.ocmd.procedures.BosslootProcedure;
import net.mcreator.ocmd.entity.renderer.ThesilverwitchRenderer;
...
public class ThesilverwitchEntity extends OcmModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.8f)).build("thesilverwitch").setRegistryName("thesilverwitch");

	public ThesilverwitchEntity(OcmModElements instance) {
		super(instance, 209);
		FMLJavaModLoadingContext.get().getModEventBus().register(new ThesilverwitchRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16764058, -13434829, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("thesilverwitch_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.MAX_HEALTH, 840);
			ammma = ammma.createMutableAttribute(Attributes.ARMOR, 0);
			ammma = ammma.createMutableAttribute(Attributes.ATTACK_DAMAGE, 64);
	...
	public static class CustomEntity extends WitchEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(10, new NearestAttackableTargetGoal(this, ServerPlayerEntity.class, false, false));
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("ocm:animegirlgiggle"));
		}
		...
		public void onDeath(DamageSource source) {
			...
			BosslootProcedure.executeProcedure(Stream
		...
		public void baseTick() {
			...
			ThesilverwitchQuandLentiteEstBlesseeProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
