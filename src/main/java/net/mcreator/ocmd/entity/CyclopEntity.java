...
import net.mcreator.ocmd.entity.renderer.CyclopRenderer;
import net.mcreator.ocmd.OcmModElements;

@OcmModElements.ModElement.Tag
public class CyclopEntity extends OcmModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.7999999999999999f, 3.4f)).build("cyclop").setRegistryName("cyclop");

	public CyclopEntity(OcmModElements instance) {
		super(instance, 168);
		FMLJavaModLoadingContext.get().getModEventBus().register(new CyclopRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -7702948, -9875661, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("cyclop_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, SheepEntity.class, false, false));
		}
