...
import net.mcreator.ocmd.entity.renderer.Undeadwolft1Renderer;
import net.mcreator.ocmd.OcmModElements;

@OcmModElements.ModElement.Tag
public class Undeadwolft1Entity extends OcmModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("undeadwolft_1").setRegistryName("undeadwolft_1");

	public Undeadwolft1Entity(OcmModElements instance) {
		super(instance, 189);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Undeadwolft1Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10053376, -8620691, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("undeadwolft_1_spawn_egg"));
	}
