...
import net.mcreator.ocmd.procedures.AssasinQuandLeJoueurFaitUnClicDroitSurLentiteProcedure;
import net.mcreator.ocmd.item.KatanaItem;
import net.mcreator.ocmd.entity.renderer.AssasinRenderer;
...
public class AssasinEntity extends OcmModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("assasin").setRegistryName("assasin");

	public AssasinEntity(OcmModElements instance) {
		super(instance, 192);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10922154, -5855578, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("assasin_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(KatanaItem.block));
		}
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			AssasinQuandLeJoueurFaitUnClicDroitSurLentiteProcedure.executeProcedure(Stream
