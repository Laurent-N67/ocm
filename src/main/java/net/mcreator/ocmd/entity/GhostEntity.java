...
import net.mcreator.ocmd.entity.renderer.GhostRenderer;
import net.mcreator.ocmd.OcmModElements;

import java.util.Random;

@OcmModElements.ModElement.Tag
public class GhostEntity extends OcmModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("ghost").setRegistryName("ghost");

	public GhostEntity(OcmModElements instance) {
		super(instance, 86);
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -6710887, -16777216, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("ghost_spawn_egg"));
	}
