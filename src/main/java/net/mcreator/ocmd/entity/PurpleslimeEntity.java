...
import net.mcreator.ocmd.entity.renderer.PurpleslimeRenderer;
import net.mcreator.ocmd.OcmModElements;

@OcmModElements.ModElement.Tag
public class PurpleslimeEntity extends OcmModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 1f))
					.build("purpleslime").setRegistryName("purpleslime");

	public PurpleslimeEntity(OcmModElements instance) {
		super(instance, 155);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PurpleslimeRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13434829, -10092442, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("purpleslime_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(PurpleslimeballItem.block));
		}
