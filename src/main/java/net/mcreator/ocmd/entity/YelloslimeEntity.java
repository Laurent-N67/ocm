...
import net.mcreator.ocmd.entity.renderer.YelloslimeRenderer;
import net.mcreator.ocmd.OcmModElements;

@OcmModElements.ModElement.Tag
public class YelloslimeEntity extends OcmModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 1f))
					.build("yelloslime").setRegistryName("yelloslime");

	public YelloslimeEntity(OcmModElements instance) {
		super(instance, 154);
		FMLJavaModLoadingContext.get().getModEventBus().register(new YelloslimeRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066432, -3355648, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("yelloslime_spawn_egg"));
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("shattered_savanna_plateau").equals(event.getName()))
			biomeCriteria = true;
		if (new ResourceLocation("ocm:farmmesa").equals(event.getName()))
			biomeCriteria = true;
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(YelloslimeballItem.block));
		}
