...
import net.mcreator.ocmd.procedures.GoblinriftOnInitialEntitySpawnProcedure;
import net.mcreator.ocmd.item.TopazGemItem;
import net.mcreator.ocmd.entity.renderer.GoblinriftRenderer;
...
public class GoblinriftEntity extends OcmModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.4f, 0.3f)).build("goblinrift").setRegistryName("goblinrift");
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletgoblinrift").setRegistryName("entitybulletgoblinrift");

	public GoblinriftEntity(OcmModElements instance) {
		super(instance, 130);
		FMLJavaModLoadingContext.get().getModEventBus().register(new GoblinriftRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3407821, -13434880, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("goblinrift_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			GoblinriftOnInitialEntitySpawnProcedure.executeProcedure(Stream
	...
	private static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(TopazGemItem.block);
		}
