...
import net.mcreator.ocmd.entity.renderer.BonebagT3Renderer;
import net.mcreator.ocmd.OcmModElements;

@OcmModElements.ModElement.Tag
public class BonebagT3Entity extends OcmModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("bonebag_t_3").setRegistryName("bonebag_t_3");

	public BonebagT3Entity(OcmModElements instance) {
		super(instance, 188);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BonebagT3Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10053376, -8620691, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("bonebag_t_3_spawn_egg"));
	}
