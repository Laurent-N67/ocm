...
import net.mcreator.ocmd.entity.renderer.BlackslimeRenderer;
import net.mcreator.ocmd.OcmModElements;

@OcmModElements.ModElement.Tag
public class BlackslimeEntity extends OcmModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 1f))
					.build("blackslime").setRegistryName("blackslime");

	public BlackslimeEntity(OcmModElements instance) {
		super(instance, 158);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BlackslimeRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -13421773, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("blackslime_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(BlackslimeballItem.block));
		}
