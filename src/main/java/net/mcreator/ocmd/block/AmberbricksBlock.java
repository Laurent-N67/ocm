...
public class AmberbricksBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:amberbricks")
	public static final Block block = null;

	public AmberbricksBlock(OcmModElements instance) {
		super(instance, 985);
	}
