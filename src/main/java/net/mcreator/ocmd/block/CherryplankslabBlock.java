...
public class CherryplankslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:cherryplankslab")
	public static final Block block = null;

	public CherryplankslabBlock(OcmModElements instance) {
		super(instance, 2238);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("cherryplankslab");
		}
