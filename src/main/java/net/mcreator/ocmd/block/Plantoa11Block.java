...
public class Plantoa11Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:plantoa_11")
	public static final Block block = null;

	public Plantoa11Block(OcmModElements instance) {
		super(instance, 1148);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("plantoa_11"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ocm:plantoa_11"), configuredFeature);
		}
	}
