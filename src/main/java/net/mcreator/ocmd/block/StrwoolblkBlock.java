...
public class StrwoolblkBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:strwoolblk")
	public static final Block block = null;

	public StrwoolblkBlock(OcmModElements instance) {
		super(instance, 403);
	}
