...
public class KyanitewistedBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:kyanitewisted")
	public static final Block block = null;

	public KyanitewistedBlock(OcmModElements instance) {
		super(instance, 1079);
	}
