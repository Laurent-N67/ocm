...
public class TitanesmoothstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:titanesmoothstair")
	public static final Block block = null;

	public TitanesmoothstairBlock(OcmModElements instance) {
		super(instance, 2181);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("titanesmoothstair");
		}
