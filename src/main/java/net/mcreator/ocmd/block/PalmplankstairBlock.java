...
public class PalmplankstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:palmplankstair")
	public static final Block block = null;

	public PalmplankstairBlock(OcmModElements instance) {
		super(instance, 2265);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("palmplankstair");
		}
