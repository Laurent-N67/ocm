...
public class LeavessakuraBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:leavessakura")
	public static final Block block = null;

	public LeavessakuraBlock(OcmModElements instance) {
		super(instance, 761);
	}
