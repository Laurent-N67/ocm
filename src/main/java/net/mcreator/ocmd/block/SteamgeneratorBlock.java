...
public class SteamgeneratorBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:steamgenerator")
	public static final Block block = null;

	public SteamgeneratorBlock(OcmModElements instance) {
		super(instance, 923);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("steamgenerator");
		}
