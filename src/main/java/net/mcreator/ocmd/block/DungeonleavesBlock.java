...
public class DungeonleavesBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonleaves")
	public static final Block block = null;

	public DungeonleavesBlock(OcmModElements instance) {
		super(instance, 1309);
