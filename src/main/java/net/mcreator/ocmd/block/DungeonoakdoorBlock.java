...
public class DungeonoakdoorBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonoakdoor")
	public static final Block block = null;

	public DungeonoakdoorBlock(OcmModElements instance) {
		super(instance, 1344);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			...
			setRegistryName("dungeonoakdoor");
		}
