...
public class IroningotslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ironingotslab")
	public static final Block block = null;

	public IroningotslabBlock(OcmModElements instance) {
		super(instance, 1060);
	}
