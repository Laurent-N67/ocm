...
public class BlocksupportbirchBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:blocksupportbirch")
	public static final Block block = null;

	public BlocksupportbirchBlock(OcmModElements instance) {
		super(instance, 764);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("blocksupportbirch");
		}
