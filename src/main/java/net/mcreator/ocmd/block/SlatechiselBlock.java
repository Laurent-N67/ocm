...
public class SlatechiselBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:slatechisel")
	public static final Block block = null;

	public SlatechiselBlock(OcmModElements instance) {
		super(instance, 2211);
	}
