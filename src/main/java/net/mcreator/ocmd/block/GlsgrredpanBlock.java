...
public class GlsgrredpanBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:glsgrredpan")
	public static final Block block = null;

	public GlsgrredpanBlock(OcmModElements instance) {
		super(instance, 947);
	}
