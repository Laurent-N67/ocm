...
public class Path3Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:path_3")
	public static final Block block = null;

	public Path3Block(OcmModElements instance) {
		super(instance, 970);
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(0, 0, 0, 16, 0.4, 16)
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(StonepathItem.block));
		}
	}
}
