...
public class KyanitepillarBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:kyanitepillar")
	public static final Block block = null;

	public KyanitepillarBlock(OcmModElements instance) {
		super(instance, 1073);
	}
