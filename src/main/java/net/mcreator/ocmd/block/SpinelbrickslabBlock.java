...
public class SpinelbrickslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:spinelbrickslab")
	public static final Block block = null;

	public SpinelbrickslabBlock(OcmModElements instance) {
		super(instance, 2173);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("spinelbrickslab");
		}
