...
public class PalmplankfenceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:palmplankfence")
	public static final Block block = null;

	public PalmplankfenceBlock(OcmModElements instance) {
		super(instance, 2267);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("palmplankfence");
		}
