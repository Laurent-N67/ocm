...
public class PeridotpillarBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:peridotpillar")
	public static final Block block = null;

	public PeridotpillarBlock(OcmModElements instance) {
		super(instance, 1121);
	}
