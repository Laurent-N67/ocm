...
public class PlatformsavanaBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:platformsavana")
	public static final Block block = null;

	public PlatformsavanaBlock(OcmModElements instance) {
		super(instance, 779);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("platformsavana");
		}
