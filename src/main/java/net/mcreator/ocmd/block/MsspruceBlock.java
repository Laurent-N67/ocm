...
public class MsspruceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:msspruce")
	public static final Block block = null;

	public MsspruceBlock(OcmModElements instance) {
		super(instance, 590);
	}
