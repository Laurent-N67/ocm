...
public class MithrilingotblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:mithrilingotblock")
	public static final Block block = null;

	public MithrilingotblockBlock(OcmModElements instance) {
		super(instance, 1095);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mithrilingotblock");
		}
