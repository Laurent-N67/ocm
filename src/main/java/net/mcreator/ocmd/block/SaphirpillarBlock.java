...
public class SaphirpillarBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:saphirpillar")
	public static final Block block = null;

	public SaphirpillarBlock(OcmModElements instance) {
		super(instance, 2144);
	}
