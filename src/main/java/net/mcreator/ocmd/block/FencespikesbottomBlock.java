...
public class FencespikesbottomBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:fencespikesbottom")
	public static final Block block = null;

	public FencespikesbottomBlock(OcmModElements instance) {
		super(instance, 980);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("fencespikesbottom");
		}
