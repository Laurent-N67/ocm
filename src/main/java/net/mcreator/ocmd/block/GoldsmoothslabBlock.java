...
public class GoldsmoothslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:goldsmoothslab")
	public static final Block block = null;

	public GoldsmoothslabBlock(OcmModElements instance) {
		super(instance, 1041);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("goldsmoothslab");
		}
