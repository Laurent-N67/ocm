...
public class DungeonmoussycobblestoneBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonmoussycobblestone")
	public static final Block block = null;

	public DungeonmoussycobblestoneBlock(OcmModElements instance) {
		super(instance, 1346);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dungeonmoussycobblestone");
		}
