...
public class Numberblock4Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:numberblock_4")
	public static final Block block = null;

	public Numberblock4Block(OcmModElements instance) {
		super(instance, 916);
	}
