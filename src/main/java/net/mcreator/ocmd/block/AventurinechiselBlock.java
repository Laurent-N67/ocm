...
public class AventurinechiselBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:aventurinechisel")
	public static final Block block = null;

	public AventurinechiselBlock(OcmModElements instance) {
		super(instance, 1001);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aventurinechisel");
		}
