...
public class DungeonlightstonebickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonlightstonebick")
	public static final Block block = null;

	public DungeonlightstonebickBlock(OcmModElements instance) {
		super(instance, 1349);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dungeonlightstonebick");
		}
