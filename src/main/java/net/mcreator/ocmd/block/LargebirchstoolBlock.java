...
public class LargebirchstoolBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:largebirchstool")
	public static final Block block = null;

	public LargebirchstoolBlock(OcmModElements instance) {
		super(instance, 863);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("largebirchstool");
		}
