...
public class AventurinetilesmallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:aventurinetilesmall")
	public static final Block block = null;

	public AventurinetilesmallBlock(OcmModElements instance) {
		super(instance, 1003);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aventurinetilesmall");
		}
