...
public class BlumplankslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:blumplankslab")
	public static final Block block = null;

	public BlumplankslabBlock(OcmModElements instance) {
		super(instance, 2234);
	}
