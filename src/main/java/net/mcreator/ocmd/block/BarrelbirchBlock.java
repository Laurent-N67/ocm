...
public class BarrelbirchBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:barrelbirch")
	public static final Block block = null;

	public BarrelbirchBlock(OcmModElements instance) {
		super(instance, 832);
	}
