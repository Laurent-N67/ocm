...
public class DungeonstonestairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonstonestair")
	public static final Block block = null;

	public DungeonstonestairBlock(OcmModElements instance) {
		super(instance, 1299);
	}
		...
		public CustomBlock() {
			super(() -> new Block(
					Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 0))
							.getDefaultState(),
					Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 0));
			setRegistryName("dungeonstonestair");
		}
