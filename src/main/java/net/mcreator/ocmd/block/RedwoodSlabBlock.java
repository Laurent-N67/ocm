...
public class RedwoodSlabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:redwood_slab")
	public static final Block block = null;

	public RedwoodSlabBlock(OcmModElements instance) {
		super(instance, 819);
	}
