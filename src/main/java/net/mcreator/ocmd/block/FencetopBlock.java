...
public class FencetopBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:fencetop")
	public static final Block block = null;

	public FencetopBlock(OcmModElements instance) {
		super(instance, 979);
	}
