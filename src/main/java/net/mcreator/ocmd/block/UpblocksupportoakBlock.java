...
public class UpblocksupportoakBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:upblocksupportoak")
	public static final Block block = null;

	public UpblocksupportoakBlock(OcmModElements instance) {
		super(instance, 769);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("upblocksupportoak");
		}
