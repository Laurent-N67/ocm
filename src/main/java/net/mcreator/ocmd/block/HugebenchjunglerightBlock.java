...
public class HugebenchjunglerightBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:hugebenchjungleright")
	public static final Block block = null;

	public HugebenchjunglerightBlock(OcmModElements instance) {
		super(instance, 856);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("hugebenchjungleright");
		}
