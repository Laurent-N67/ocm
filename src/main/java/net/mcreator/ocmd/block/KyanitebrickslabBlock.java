...
public class KyanitebrickslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:kyanitebrickslab")
	public static final Block block = null;

	public KyanitebrickslabBlock(OcmModElements instance) {
		super(instance, 1081);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("kyanitebrickslab");
		}
