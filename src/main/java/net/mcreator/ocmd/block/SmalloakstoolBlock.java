...
public class SmalloakstoolBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:smalloakstool")
	public static final Block block = null;

	public SmalloakstoolBlock(OcmModElements instance) {
		super(instance, 857);
	}
