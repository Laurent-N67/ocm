...
public class StrwoolpikBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:strwoolpik")
	public static final Block block = null;

	public StrwoolpikBlock(OcmModElements instance) {
		super(instance, 409);
	}
