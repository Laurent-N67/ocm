...
public class DalleupjungleBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dalleupjungle")
	public static final Block block = null;

	public DalleupjungleBlock(OcmModElements instance) {
		super(instance, 746);
	}
