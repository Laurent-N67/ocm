...
public class GoldtilefenceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:goldtilefence")
	public static final Block block = null;

	public GoldtilefenceBlock(OcmModElements instance) {
		super(instance, 1045);
	}
