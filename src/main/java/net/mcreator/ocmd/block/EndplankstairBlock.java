...
public class EndplankstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:endplankstair")
	public static final Block block = null;

	public EndplankstairBlock(OcmModElements instance) {
		super(instance, 2253);
	}
