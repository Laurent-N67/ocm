...
public class Dungeonpillar2Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonpillar_2")
	public static final Block block = null;

	public Dungeonpillar2Block(OcmModElements instance) {
		super(instance, 1311);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dungeonpillar_2");
		}
