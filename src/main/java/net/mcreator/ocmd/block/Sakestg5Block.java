...
public class Sakestg5Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:sakestg_5")
	public static final Block block = null;

	public Sakestg5Block(OcmModElements instance) {
		super(instance, 604);
	}
