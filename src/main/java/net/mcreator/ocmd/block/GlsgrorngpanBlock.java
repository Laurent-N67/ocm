...
public class GlsgrorngpanBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:glsgrorngpan")
	public static final Block block = null;

	public GlsgrorngpanBlock(OcmModElements instance) {
		super(instance, 951);
	}
