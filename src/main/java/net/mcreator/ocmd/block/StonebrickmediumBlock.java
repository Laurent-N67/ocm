...
public class StonebrickmediumBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:stonebrickmedium")
	public static final Block block = null;

	public StonebrickmediumBlock(OcmModElements instance) {
		super(instance, 982);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stonebrickmedium");
		}
