...
public class PlankdarkoakghostBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:plankdarkoakghost")
	public static final Block block = null;

	public PlankdarkoakghostBlock(OcmModElements instance) {
		super(instance, 964);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("plankdarkoakghost");
		}
