...
public class GoldingotblockstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:goldingotblockstair")
	public static final Block block = null;

	public GoldingotblockstairBlock(OcmModElements instance) {
		super(instance, 1034);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("goldingotblockstair");
		}
