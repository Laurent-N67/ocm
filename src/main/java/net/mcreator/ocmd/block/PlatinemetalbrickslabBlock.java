...
public class PlatinemetalbrickslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:platinemetalbrickslab")
	public static final Block block = null;

	public PlatinemetalbrickslabBlock(OcmModElements instance) {
		super(instance, 2127);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("platinemetalbrickslab");
		}
