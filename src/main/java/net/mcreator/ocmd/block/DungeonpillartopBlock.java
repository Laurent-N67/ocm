...
public class DungeonpillartopBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonpillartop")
	public static final Block block = null;

	public DungeonpillartopBlock(OcmModElements instance) {
		super(instance, 904);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dungeonpillartop");
		}
