...
public class SpinelwistedBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:spinelwisted")
	public static final Block block = null;

	public SpinelwistedBlock(OcmModElements instance) {
		super(instance, 2171);
	}
