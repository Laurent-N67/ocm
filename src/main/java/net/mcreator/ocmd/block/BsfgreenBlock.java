...
public class BsfgreenBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:bsfgreen")
	public static final Block block = null;

	public BsfgreenBlock(OcmModElements instance) {
		super(instance, 666);
	}
