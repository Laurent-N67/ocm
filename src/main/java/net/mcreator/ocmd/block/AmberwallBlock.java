...
public class AmberwallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:amberwall")
	public static final Block block = null;

	public AmberwallBlock(OcmModElements instance) {
		super(instance, 996);
	}
