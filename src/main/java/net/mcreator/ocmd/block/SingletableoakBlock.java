...
public class SingletableoakBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:singletableoak")
	public static final Block block = null;

	public SingletableoakBlock(OcmModElements instance) {
		super(instance, 737);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("singletableoak");
		}
