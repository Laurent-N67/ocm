...
public class MithrilfenceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:mithrilfence")
	public static final Block block = null;

	public MithrilfenceBlock(OcmModElements instance) {
		super(instance, 1107);
	}
