...
public class NacreweaverBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:nacreweaver")
	public static final Block block = null;

	public NacreweaverBlock(OcmModElements instance) {
		super(instance, 1115);
	}
