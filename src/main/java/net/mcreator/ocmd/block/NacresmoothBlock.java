...
public class NacresmoothBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:nacresmooth")
	public static final Block block = null;

	public NacresmoothBlock(OcmModElements instance) {
		super(instance, 1111);
	}
