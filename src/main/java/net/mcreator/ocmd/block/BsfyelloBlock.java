...
public class BsfyelloBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:bsfyello")
	public static final Block block = null;

	public BsfyelloBlock(OcmModElements instance) {
		super(instance, 667);
	}
