...
public class DarkmetalstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:darkmetalstair")
	public static final Block block = null;

	public DarkmetalstairBlock(OcmModElements instance) {
		super(instance, 716);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("darkmetalstair");
		}
