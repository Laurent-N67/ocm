...
public class TopaztilesmallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:topaztilesmall")
	public static final Block block = null;

	public TopaztilesmallBlock(OcmModElements instance) {
		super(instance, 2192);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("topaztilesmall");
		}
