...
public class PlatformspruceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:platformspruce")
	public static final Block block = null;

	public PlatformspruceBlock(OcmModElements instance) {
		super(instance, 776);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("platformspruce");
		}
