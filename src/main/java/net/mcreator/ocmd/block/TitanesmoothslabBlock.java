...
public class TitanesmoothslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:titanesmoothslab")
	public static final Block block = null;

	public TitanesmoothslabBlock(OcmModElements instance) {
		super(instance, 2182);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("titanesmoothslab");
		}
