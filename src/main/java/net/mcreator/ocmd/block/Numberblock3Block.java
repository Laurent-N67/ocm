...
public class Numberblock3Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:numberblock_3")
	public static final Block block = null;

	public Numberblock3Block(OcmModElements instance) {
		super(instance, 915);
	}
