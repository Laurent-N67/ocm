...
public class MarblebricksmallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:marblebricksmall")
	public static final Block block = null;

	public MarblebricksmallBlock(OcmModElements instance) {
		super(instance, 1084);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("marblebricksmall");
		}
