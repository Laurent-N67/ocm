...
public class SlatebrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:slatebrick")
	public static final Block block = null;

	public SlatebrickBlock(OcmModElements instance) {
		super(instance, 2153);
	}
