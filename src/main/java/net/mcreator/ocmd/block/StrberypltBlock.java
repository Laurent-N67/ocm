...
import net.mcreator.ocmd.item.StrberyItem;
...
public class StrberypltBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:strberyplt")
	public static final Block block = null;

	public StrberypltBlock(OcmModElements instance) {
		super(instance, 1136);
	}
	...
	public static class BlockCustomFlower extends SugarCaneBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(StrberyItem.block, (int) (2)));
		}
