...
public class MithriltileBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:mithriltile")
	public static final Block block = null;

	public MithriltileBlock(OcmModElements instance) {
		super(instance, 1104);
	}
