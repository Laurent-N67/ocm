...
public class BenchleftBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:benchleft")
	public static final Block block = null;

	public BenchleftBlock(OcmModElements instance) {
		super(instance, 843);
	}
