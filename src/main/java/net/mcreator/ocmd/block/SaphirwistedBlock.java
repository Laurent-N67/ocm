...
public class SaphirwistedBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:saphirwisted")
	public static final Block block = null;

	public SaphirwistedBlock(OcmModElements instance) {
		super(instance, 2150);
	}
