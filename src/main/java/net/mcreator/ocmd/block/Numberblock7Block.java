...
public class Numberblock7Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:numberblock_7")
	public static final Block block = null;

	public Numberblock7Block(OcmModElements instance) {
		super(instance, 919);
	}
