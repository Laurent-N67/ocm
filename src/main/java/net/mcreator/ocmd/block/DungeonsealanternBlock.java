...
public class DungeonsealanternBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonsealantern")
	public static final Block block = null;

	public DungeonsealanternBlock(OcmModElements instance) {
		super(instance, 1356);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 0)
					.slipperiness(2.5f));
			setRegistryName("dungeonsealantern");
		}
