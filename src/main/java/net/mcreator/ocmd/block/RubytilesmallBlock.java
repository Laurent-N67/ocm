...
public class RubytilesmallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:rubytilesmall")
	public static final Block block = null;

	public RubytilesmallBlock(OcmModElements instance) {
		super(instance, 2137);
	}
