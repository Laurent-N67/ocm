...
public class PlatinetileBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:platinetile")
	public static final Block block = null;

	public PlatinetileBlock(OcmModElements instance) {
		super(instance, 2128);
	}
