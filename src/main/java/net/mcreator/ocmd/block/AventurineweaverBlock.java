...
public class AventurineweaverBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:aventurineweaver")
	public static final Block block = null;

	public AventurineweaverBlock(OcmModElements instance) {
		super(instance, 1004);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aventurineweaver");
		}
