...
public class Numberblock5Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:numberblock_5")
	public static final Block block = null;

	public Numberblock5Block(OcmModElements instance) {
		super(instance, 917);
	}
