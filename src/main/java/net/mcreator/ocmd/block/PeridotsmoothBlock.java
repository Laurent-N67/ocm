...
public class PeridotsmoothBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:peridotsmooth")
	public static final Block block = null;

	public PeridotsmoothBlock(OcmModElements instance) {
		super(instance, 1122);
	}
