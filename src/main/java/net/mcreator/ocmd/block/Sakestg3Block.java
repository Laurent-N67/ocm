...
import net.mcreator.ocmd.procedures.Sakestg3UpdateTickProcedure;
...
public class Sakestg3Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:sakestg_3")
	public static final Block block = null;

	public Sakestg3Block(OcmModElements instance) {
		super(instance, 602);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			Sakestg3UpdateTickProcedure.executeProcedure(Stream
