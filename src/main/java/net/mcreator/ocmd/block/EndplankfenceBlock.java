...
public class EndplankfenceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:endplankfence")
	public static final Block block = null;

	public EndplankfenceBlock(OcmModElements instance) {
		super(instance, 2255);
	}
