...
public class CollombagecrosslineBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:collombagecrossline")
	public static final Block block = null;

	public CollombagecrosslineBlock(OcmModElements instance) {
		super(instance, 385);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("collombagecrossline");
		}
