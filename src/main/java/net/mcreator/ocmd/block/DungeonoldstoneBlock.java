...
public class DungeonoldstoneBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonoldstone")
	public static final Block block = null;

	public DungeonoldstoneBlock(OcmModElements instance) {
		super(instance, 1314);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dungeonoldstone");
		}
