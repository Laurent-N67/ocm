...
public class Numberblock1Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:numberblock_1")
	public static final Block block = null;

	public Numberblock1Block(OcmModElements instance) {
		super(instance, 913);
	}
