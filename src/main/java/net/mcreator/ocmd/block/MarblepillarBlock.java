...
public class MarblepillarBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:marblepillar")
	public static final Block block = null;

	public MarblepillarBlock(OcmModElements instance) {
		super(instance, 1086);
	}
