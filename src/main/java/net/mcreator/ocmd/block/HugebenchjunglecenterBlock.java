...
public class HugebenchjunglecenterBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:hugebenchjunglecenter")
	public static final Block block = null;

	public HugebenchjunglecenterBlock(OcmModElements instance) {
		super(instance, 855);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("hugebenchjunglecenter");
		}
