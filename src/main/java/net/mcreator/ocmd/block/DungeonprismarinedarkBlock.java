...
public class DungeonprismarinedarkBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonprismarinedark")
	public static final Block block = null;

	public DungeonprismarinedarkBlock(OcmModElements instance) {
		super(instance, 1355);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 0)
					.slipperiness(2.5f));
			setRegistryName("dungeonprismarinedark");
		}
