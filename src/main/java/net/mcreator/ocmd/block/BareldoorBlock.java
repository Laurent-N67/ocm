...
public class BareldoorBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:bareldoor")
	public static final Block block = null;

	public BareldoorBlock(OcmModElements instance) {
		super(instance, 905);
	}
