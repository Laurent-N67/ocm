...
public class StrwoolwhtBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:strwoolwht")
	public static final Block block = null;

	public StrwoolwhtBlock(OcmModElements instance) {
		super(instance, 393);
	}
