...
public class DalleupoakBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dalleupoak")
	public static final Block block = null;

	public DalleupoakBlock(OcmModElements instance) {
		super(instance, 744);
	}
