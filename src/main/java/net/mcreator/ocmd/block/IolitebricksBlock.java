...
public class IolitebricksBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:iolitebricks")
	public static final Block block = null;

	public IolitebricksBlock(OcmModElements instance) {
		super(instance, 1046);
	}
