...
public class AmberweaverBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:amberweaver")
	public static final Block block = null;

	public AmberweaverBlock(OcmModElements instance) {
		super(instance, 992);
	}
