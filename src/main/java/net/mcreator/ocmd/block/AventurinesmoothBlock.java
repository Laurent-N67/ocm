...
public class AventurinesmoothBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:aventurinesmooth")
	public static final Block block = null;

	public AventurinesmoothBlock(OcmModElements instance) {
		super(instance, 1000);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aventurinesmooth");
		}
