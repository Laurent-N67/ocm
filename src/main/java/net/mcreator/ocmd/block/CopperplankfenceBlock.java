...
public class CopperplankfenceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:copperplankfence")
	public static final Block block = null;

	public CopperplankfenceBlock(OcmModElements instance) {
		super(instance, 2247);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("copperplankfence");
		}
