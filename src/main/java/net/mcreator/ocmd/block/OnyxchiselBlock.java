...
public class OnyxchiselBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:onyxchisel")
	public static final Block block = null;

	public OnyxchiselBlock(OcmModElements instance) {
		super(instance, 2201);
	}
