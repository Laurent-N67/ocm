...
public class BarreljungleBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:barreljungle")
	public static final Block block = null;

	public BarreljungleBlock(OcmModElements instance) {
		super(instance, 834);
	}
