...
public class SpinelsmoothBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:spinelsmooth")
	public static final Block block = null;

	public SpinelsmoothBlock(OcmModElements instance) {
		super(instance, 2166);
	}
