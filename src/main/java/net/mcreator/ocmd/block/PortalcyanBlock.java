...
public class PortalcyanBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:portalcyan")
	public static final Block block = null;

	public PortalcyanBlock(OcmModElements instance) {
		super(instance, 641);
	}
