...
public class Chisbk1Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:chisbk_1")
	public static final Block block = null;

	public Chisbk1Block(OcmModElements instance) {
		super(instance, 613);
	}
