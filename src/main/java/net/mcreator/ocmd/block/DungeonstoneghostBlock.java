...
public class DungeonstoneghostBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonstoneghost")
	public static final Block block = null;

	public DungeonstoneghostBlock(OcmModElements instance) {
		super(instance, 1330);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dungeonstoneghost");
		}
