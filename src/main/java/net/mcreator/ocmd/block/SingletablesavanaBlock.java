...
public class SingletablesavanaBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:singletablesavana")
	public static final Block block = null;

	public SingletablesavanaBlock(OcmModElements instance) {
		super(instance, 741);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("singletablesavana");
		}
