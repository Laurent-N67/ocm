...
public class RubychiselBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:rubychisel")
	public static final Block block = null;

	public RubychiselBlock(OcmModElements instance) {
		super(instance, 2135);
	}
