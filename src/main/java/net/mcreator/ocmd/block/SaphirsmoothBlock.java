...
public class SaphirsmoothBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:saphirsmooth")
	public static final Block block = null;

	public SaphirsmoothBlock(OcmModElements instance) {
		super(instance, 2145);
	}
