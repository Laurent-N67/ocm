...
public class NacrebrickstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:nacrebrickstair")
	public static final Block block = null;

	public NacrebrickstairBlock(OcmModElements instance) {
		super(instance, 1117);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("nacrebrickstair");
		}
