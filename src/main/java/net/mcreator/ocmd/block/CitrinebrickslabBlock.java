...
public class CitrinebrickslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:citrinebrickslab")
	public static final Block block = null;

	public CitrinebrickslabBlock(OcmModElements instance) {
		super(instance, 1019);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("citrinebrickslab");
		}
