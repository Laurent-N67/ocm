...
public class DungeonslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonslab")
	public static final Block block = null;

	public DungeonslabBlock(OcmModElements instance) {
		super(instance, 899);
	}
