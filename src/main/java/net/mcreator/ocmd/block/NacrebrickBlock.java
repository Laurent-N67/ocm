...
public class NacrebrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:nacrebrick")
	public static final Block block = null;

	public NacrebrickBlock(OcmModElements instance) {
		super(instance, 1108);
	}
