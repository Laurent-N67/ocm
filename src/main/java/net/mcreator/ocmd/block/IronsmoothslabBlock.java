...
public class IronsmoothslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ironsmoothslab")
	public static final Block block = null;

	public IronsmoothslabBlock(OcmModElements instance) {
		super(instance, 1066);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("ironsmoothslab");
		}
