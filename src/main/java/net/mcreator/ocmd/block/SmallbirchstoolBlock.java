...
public class SmallbirchstoolBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:smallbirchstool")
	public static final Block block = null;

	public SmallbirchstoolBlock(OcmModElements instance) {
		super(instance, 859);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smallbirchstool");
		}
