...
import net.mcreator.ocmd.procedures.Spawnerlvl1MiseAJourDuTickProcedure;
...
public class Spawnerlvl1Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:spawnerlvl_1")
	public static final Block block = null;

	public Spawnerlvl1Block(OcmModElements instance) {
		super(instance, 867);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(250f, 50000f).setLightLevel(s -> 0));
			setRegistryName("spawnerlvl_1");
		}
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			int y = pos.getY();
			int z = pos.getZ();
			world.getPendingBlockTicks().scheduleTick(pos, this, 300);
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			Spawnerlvl1MiseAJourDuTickProcedure.executeProcedure(Stream
