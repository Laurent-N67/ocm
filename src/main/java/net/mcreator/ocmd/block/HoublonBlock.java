...
public class HoublonBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:houblon")
	public static final Block block = null;

	public HoublonBlock(OcmModElements instance) {
		super(instance, 1130);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("houblon"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ocm:houblon"), configuredFeature);
		}
	}
