...
public class SmallsprucestoolBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:smallsprucestool")
	public static final Block block = null;

	public SmallsprucestoolBlock(OcmModElements instance) {
		super(instance, 858);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smallsprucestool");
		}
