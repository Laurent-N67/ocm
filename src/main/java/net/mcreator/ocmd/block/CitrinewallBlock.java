...
public class CitrinewallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:citrinewall")
	public static final Block block = null;

	public CitrinewallBlock(OcmModElements instance) {
		super(instance, 1020);
	}
