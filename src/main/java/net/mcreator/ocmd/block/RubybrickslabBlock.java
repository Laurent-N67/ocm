...
public class RubybrickslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:rubybrickslab")
	public static final Block block = null;

	public RubybrickslabBlock(OcmModElements instance) {
		super(instance, 2141);
	}
