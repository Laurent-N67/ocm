...
public class DungeonbrickslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonbrickslab")
	public static final Block block = null;

	public DungeonbrickslabBlock(OcmModElements instance) {
		super(instance, 1339);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dungeonbrickslab");
		}
