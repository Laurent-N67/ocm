...
public class SandstoneportablockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:sandstoneportablock")
	public static final Block block = null;

	public SandstoneportablockBlock(OcmModElements instance) {
		super(instance, 891);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("sandstoneportablock");
		}
