...
public class SlatewistedBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:slatewisted")
	public static final Block block = null;

	public SlatewistedBlock(OcmModElements instance) {
		super(instance, 2160);
	}
