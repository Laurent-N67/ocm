...
public class WhitewoodStairsBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:whitewood_stairs")
	public static final Block block = null;

	public WhitewoodStairsBlock(OcmModElements instance) {
		super(instance, 825);
	}
