...
public class MarblebrickslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:marblebrickslab")
	public static final Block block = null;

	public MarblebrickslabBlock(OcmModElements instance) {
		super(instance, 1094);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("marblebrickslab");
		}
