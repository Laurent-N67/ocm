...
public class IronmetalbrickstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ironmetalbrickstair")
	public static final Block block = null;

	public IronmetalbrickstairBlock(OcmModElements instance) {
		super(instance, 1062);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("ironmetalbrickstair");
		}
