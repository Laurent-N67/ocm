...
public class PlankjungleghostBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:plankjungleghost")
	public static final Block block = null;

	public PlankjungleghostBlock(OcmModElements instance) {
		super(instance, 962);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("plankjungleghost");
		}
