...
public class MithrilmetalbrickstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:mithrilmetalbrickstair")
	public static final Block block = null;

	public MithrilmetalbrickstairBlock(OcmModElements instance) {
		super(instance, 1099);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("mithrilmetalbrickstair");
		}
