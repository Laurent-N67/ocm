...
public class EmeraldplankfenceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:emeraldplankfence")
	public static final Block block = null;

	public EmeraldplankfenceBlock(OcmModElements instance) {
		super(instance, 2251);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("emeraldplankfence");
		}
