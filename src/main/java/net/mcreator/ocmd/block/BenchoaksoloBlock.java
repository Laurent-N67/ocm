...
public class BenchoaksoloBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:benchoaksolo")
	public static final Block block = null;

	public BenchoaksoloBlock(OcmModElements instance) {
		super(instance, 841);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(16, 0, 16, 0, 11.200000000000001, 0)
				...
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(0, 0, 0, 16, 11.200000000000001, 16)
							...
							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(16, 0, 0, 0, 11.200000000000001, 16)

					)

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(0, 0, 16, 16, 11.200000000000001, 0)
