...
public class CherryplankfenceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:cherryplankfence")
	public static final Block block = null;

	public CherryplankfenceBlock(OcmModElements instance) {
		super(instance, 2239);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("cherryplankfence");
		}
