...
public class LargejunglestoolBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:largejunglestool")
	public static final Block block = null;

	public LargejunglestoolBlock(OcmModElements instance) {
		super(instance, 864);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("largejunglestool");
		}
