...
public class YellowbrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:yellowbrick")
	public static final Block block = null;

	public YellowbrickBlock(OcmModElements instance) {
		super(instance, 461);
	}
