...
public class OnyxwistedBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:onyxwisted")
	public static final Block block = null;

	public OnyxwistedBlock(OcmModElements instance) {
		super(instance, 2205);
	}
