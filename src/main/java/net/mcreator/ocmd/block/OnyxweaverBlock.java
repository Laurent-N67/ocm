...
public class OnyxweaverBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:onyxweaver")
	public static final Block block = null;

	public OnyxweaverBlock(OcmModElements instance) {
		super(instance, 2204);
	}
