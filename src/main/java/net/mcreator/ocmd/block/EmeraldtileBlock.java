...
public class EmeraldtileBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:emeraldtile")
	public static final Block block = null;

	public EmeraldtileBlock(OcmModElements instance) {
		super(instance, 1026);
	}
