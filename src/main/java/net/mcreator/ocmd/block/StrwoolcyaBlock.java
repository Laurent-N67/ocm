...
public class StrwoolcyaBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:strwoolcya")
	public static final Block block = null;

	public StrwoolcyaBlock(OcmModElements instance) {
		super(instance, 411);
	}
