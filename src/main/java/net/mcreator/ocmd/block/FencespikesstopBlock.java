...
public class FencespikesstopBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:fencespikesstop")
	public static final Block block = null;

	public FencespikesstopBlock(OcmModElements instance) {
		super(instance, 981);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("fencespikesstop");
		}
