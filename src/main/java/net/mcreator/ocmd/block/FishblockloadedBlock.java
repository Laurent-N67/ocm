...
public class FishblockloadedBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:fishblockloaded")
	public static final Block block = null;

	public FishblockloadedBlock(OcmModElements instance) {
		super(instance, 708);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("fishblockloaded");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BagfishItem.block));
		}
	}
}
