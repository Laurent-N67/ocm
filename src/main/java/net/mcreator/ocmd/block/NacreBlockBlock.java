...
public class NacreBlockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:nacre_block")
	public static final Block block = null;

	public NacreBlockBlock(OcmModElements instance) {
		super(instance, 809);
	}
