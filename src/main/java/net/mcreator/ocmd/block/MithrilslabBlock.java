...
public class MithrilslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:mithrilslab")
	public static final Block block = null;

	public MithrilslabBlock(OcmModElements instance) {
		super(instance, 1106);
	}
