...
public class EmeraldbricksBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:emeraldbricks")
	public static final Block block = null;

	public EmeraldbricksBlock(OcmModElements instance) {
		super(instance, 1021);
	}
