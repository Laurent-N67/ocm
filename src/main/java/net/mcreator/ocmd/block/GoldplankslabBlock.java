...
public class GoldplankslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:goldplankslab")
	public static final Block block = null;

	public GoldplankslabBlock(OcmModElements instance) {
		super(instance, 2262);
	}
