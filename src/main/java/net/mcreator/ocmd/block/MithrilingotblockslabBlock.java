...
public class MithrilingotblockslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:mithrilingotblockslab")
	public static final Block block = null;

	public MithrilingotblockslabBlock(OcmModElements instance) {
		super(instance, 1097);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("mithrilingotblockslab");
		}
