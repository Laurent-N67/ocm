...
public class FlowerleavesBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:flowerleaves")
	public static final Block block = null;

	public FlowerleavesBlock(OcmModElements instance) {
		super(instance, 570);
	}
