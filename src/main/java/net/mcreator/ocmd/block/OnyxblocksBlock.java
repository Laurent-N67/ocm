...
public class OnyxblocksBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:onyxblocks")
	public static final Block block = null;

	public OnyxblocksBlock(OcmModElements instance) {
		super(instance, 2197);
	}
