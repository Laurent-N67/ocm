...
public class TitanemetalbrickstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:titanemetalbrickstair")
	public static final Block block = null;

	public TitanemetalbrickstairBlock(OcmModElements instance) {
		super(instance, 2178);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("titanemetalbrickstair");
		}
