...
public class BsfblackBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:bsfblack")
	public static final Block block = null;

	public BsfblackBlock(OcmModElements instance) {
		super(instance, 669);
	}
