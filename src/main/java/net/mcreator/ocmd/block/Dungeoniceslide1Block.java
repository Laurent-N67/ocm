...
public class Dungeoniceslide1Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeoniceslide_1")
	public static final Block block = null;

	public Dungeoniceslide1Block(OcmModElements instance) {
		super(instance, 1326);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.GLASS).sound(SoundType.GLASS).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 0)
					.slipperiness(1.1f));
			setRegistryName("dungeoniceslide_1");
		}
