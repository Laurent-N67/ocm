...
public class IcrsblueBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:icrsblue")
	public static final Block block = null;

	public IcrsblueBlock(OcmModElements instance) {
		super(instance, 525);
	}
