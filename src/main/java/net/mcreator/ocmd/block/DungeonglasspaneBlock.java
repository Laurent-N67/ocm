...
public class DungeonglasspaneBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonglasspane")
	public static final Block block = null;

	public DungeonglasspaneBlock(OcmModElements instance) {
		super(instance, 1307);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("dungeonglasspane");
		}
