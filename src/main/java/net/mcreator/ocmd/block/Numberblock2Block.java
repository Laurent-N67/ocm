...
public class Numberblock2Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:numberblock_2")
	public static final Block block = null;

	public Numberblock2Block(OcmModElements instance) {
		super(instance, 914);
	}
