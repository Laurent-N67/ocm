...
public class LavabrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:lavabrick")
	public static final Block block = null;

	public LavabrickBlock(OcmModElements instance) {
		super(instance, 558);
	}
