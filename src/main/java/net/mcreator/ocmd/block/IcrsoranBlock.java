...
public class IcrsoranBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:icrsoran")
	public static final Block block = null;

	public IcrsoranBlock(OcmModElements instance) {
		super(instance, 528);
	}
