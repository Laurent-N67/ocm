...
public class SaphirplankslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:saphirplankslab")
	public static final Block block = null;

	public SaphirplankslabBlock(OcmModElements instance) {
		super(instance, 2274);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("saphirplankslab");
		}
