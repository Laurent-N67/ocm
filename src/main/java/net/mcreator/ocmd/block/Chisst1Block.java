...
public class Chisst1Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:chisst_1")
	public static final Block block = null;

	public Chisst1Block(OcmModElements instance) {
		super(instance, 576);
	}
