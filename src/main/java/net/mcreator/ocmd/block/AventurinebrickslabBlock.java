...
public class AventurinebrickslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:aventurinebrickslab")
	public static final Block block = null;

	public AventurinebrickslabBlock(OcmModElements instance) {
		super(instance, 1007);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("aventurinebrickslab");
		}
