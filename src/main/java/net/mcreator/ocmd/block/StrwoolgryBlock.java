...
public class StrwoolgryBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:strwoolgry")
	public static final Block block = null;

	public StrwoolgryBlock(OcmModElements instance) {
		super(instance, 415);
	}
