...
public class Collombageline1Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:collombageline_1")
	public static final Block block = null;

	public Collombageline1Block(OcmModElements instance) {
		super(instance, 382);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("collombageline_1");
		}
