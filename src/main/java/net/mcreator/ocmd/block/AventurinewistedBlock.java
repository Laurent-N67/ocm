...
public class AventurinewistedBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:aventurinewisted")
	public static final Block block = null;

	public AventurinewistedBlock(OcmModElements instance) {
		super(instance, 1005);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aventurinewisted");
		}
