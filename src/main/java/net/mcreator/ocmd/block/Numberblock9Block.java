...
public class Numberblock9Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:numberblock_9")
	public static final Block block = null;

	public Numberblock9Block(OcmModElements instance) {
		super(instance, 921);
	}
