...
public class RednetherbrickstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:rednetherbrickstair")
	public static final Block block = null;

	public RednetherbrickstairBlock(OcmModElements instance) {
		super(instance, 712);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("rednetherbrickstair");
		}
