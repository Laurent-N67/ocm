...
public class CitrinesmoothBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:citrinesmooth")
	public static final Block block = null;

	public CitrinesmoothBlock(OcmModElements instance) {
		super(instance, 1012);
	}
