...
public class OnyxsmoothBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:onyxsmooth")
	public static final Block block = null;

	public OnyxsmoothBlock(OcmModElements instance) {
		super(instance, 2200);
	}
