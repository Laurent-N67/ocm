...
public class WalogjungBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:walogjung")
	public static final Block block = null;

	public WalogjungBlock(OcmModElements instance) {
		super(instance, 630);
	}
