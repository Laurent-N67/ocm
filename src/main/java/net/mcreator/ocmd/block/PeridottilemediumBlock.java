...
public class PeridottilemediumBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:peridottilemedium")
	public static final Block block = null;

	public PeridottilemediumBlock(OcmModElements instance) {
		super(instance, 1124);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("peridottilemedium");
		}
