...
public class TitaneingotblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:titaneingotblock")
	public static final Block block = null;

	public TitaneingotblockBlock(OcmModElements instance) {
		super(instance, 2174);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("titaneingotblock");
		}
