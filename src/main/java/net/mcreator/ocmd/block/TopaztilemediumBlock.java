...
public class TopaztilemediumBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:topaztilemedium")
	public static final Block block = null;

	public TopaztilemediumBlock(OcmModElements instance) {
		super(instance, 2191);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("topaztilemedium");
		}
