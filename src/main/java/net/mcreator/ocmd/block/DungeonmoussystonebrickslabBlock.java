...
public class DungeonmoussystonebrickslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonmoussystonebrickslab")
	public static final Block block = null;

	public DungeonmoussystonebrickslabBlock(OcmModElements instance) {
		super(instance, 1335);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dungeonmoussystonebrickslab");
		}
