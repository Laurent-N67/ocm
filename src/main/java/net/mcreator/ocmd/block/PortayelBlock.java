...
public class PortayelBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:portayel")
	public static final Block block = null;

	public PortayelBlock(OcmModElements instance) {
		super(instance, 644);
	}
