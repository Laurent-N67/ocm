...
public class StrwoolblueBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:strwoolblue")
	public static final Block block = null;

	public StrwoolblueBlock(OcmModElements instance) {
		super(instance, 397);
	}
