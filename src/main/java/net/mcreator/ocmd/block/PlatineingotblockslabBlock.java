...
public class PlatineingotblockslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:platineingotblockslab")
	public static final Block block = null;

	public PlatineingotblockslabBlock(OcmModElements instance) {
		super(instance, 2124);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("platineingotblockslab");
		}
