...
public class HellstoneBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:hellstone")
	public static final Block block = null;

	public HellstoneBlock(OcmModElements instance) {
		super(instance, 881);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(HellcobbleBlock.block));
		}
	}
}
