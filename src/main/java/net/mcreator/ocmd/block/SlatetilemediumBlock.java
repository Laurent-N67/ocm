...
public class SlatetilemediumBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:slatetilemedium")
	public static final Block block = null;

	public SlatetilemediumBlock(OcmModElements instance) {
		super(instance, 2157);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("slatetilemedium");
		}
