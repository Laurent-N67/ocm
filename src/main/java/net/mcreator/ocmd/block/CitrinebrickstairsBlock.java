...
public class CitrinebrickstairsBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:citrinebrickstairs")
	public static final Block block = null;

	public CitrinebrickstairsBlock(OcmModElements instance) {
		super(instance, 1018);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("citrinebrickstairs");
		}
