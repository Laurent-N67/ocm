...
public class EmeraldplankBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:emeraldplank")
	public static final Block block = null;

	public EmeraldplankBlock(OcmModElements instance) {
		super(instance, 2248);
	}
