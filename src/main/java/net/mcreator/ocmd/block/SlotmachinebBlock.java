...
import net.mcreator.ocmd.procedures.SlotmachinebLorsDunClicDroitSurLeBlocProcedure;
...
public class SlotmachinebBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:slotmachineb")
	public static final Block block = null;

	public SlotmachinebBlock(OcmModElements instance) {
		super(instance, 942);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			SlotmachinebLorsDunClicDroitSurLeBlocProcedure.executeProcedure(Stream
