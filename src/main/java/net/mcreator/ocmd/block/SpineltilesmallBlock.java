...
public class SpineltilesmallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:spineltilesmall")
	public static final Block block = null;

	public SpineltilesmallBlock(OcmModElements instance) {
		super(instance, 2169);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("spineltilesmall");
		}
