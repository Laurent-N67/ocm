...
public class HugebenchbirchleftBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:hugebenchbirchleft")
	public static final Block block = null;

	public HugebenchbirchleftBlock(OcmModElements instance) {
		super(instance, 848);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("hugebenchbirchleft");
		}
