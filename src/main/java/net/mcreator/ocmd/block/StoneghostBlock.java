...
public class StoneghostBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:stoneghost")
	public static final Block block = null;

	public StoneghostBlock(OcmModElements instance) {
		super(instance, 959);
	}
