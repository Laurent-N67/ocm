...
public class WhitewoodLeavesBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:whitewood_leaves")
	public static final Block block = null;

	public WhitewoodLeavesBlock(OcmModElements instance) {
		super(instance, 824);
	}
