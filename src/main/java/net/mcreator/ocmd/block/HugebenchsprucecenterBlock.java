...
public class HugebenchsprucecenterBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:hugebenchsprucecenter")
	public static final Block block = null;

	public HugebenchsprucecenterBlock(OcmModElements instance) {
		super(instance, 852);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("hugebenchsprucecenter");
		}
