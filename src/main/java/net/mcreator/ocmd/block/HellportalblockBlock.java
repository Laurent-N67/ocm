...
public class HellportalblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:hellportalblock")
	public static final Block block = null;

	public HellportalblockBlock(OcmModElements instance) {
		super(instance, 885);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hellportalblock");
		}
