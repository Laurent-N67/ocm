...
public class DungeonprismarineblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonprismarineblock")
	public static final Block block = null;

	public DungeonprismarineblockBlock(OcmModElements instance) {
		super(instance, 1354);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 0)
					.slipperiness(2.5f));
			setRegistryName("dungeonprismarineblock");
		}
