...
public class GoldsmoothstairsBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:goldsmoothstairs")
	public static final Block block = null;

	public GoldsmoothstairsBlock(OcmModElements instance) {
		super(instance, 1040);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("goldsmoothstairs");
		}
