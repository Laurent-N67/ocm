...
public class PetrifyleavesBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:petrifyleaves")
	public static final Block block = null;

	public PetrifyleavesBlock(OcmModElements instance) {
		super(instance, 884);
	}
