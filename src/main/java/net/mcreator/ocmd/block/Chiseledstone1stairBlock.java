...
public class Chiseledstone1stairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:chiseledstone_1stair")
	public static final Block block = null;

	public Chiseledstone1stairBlock(OcmModElements instance) {
		super(instance, 720);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseledstone_1stair");
		}
