...
public class IrontilestairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:irontilestair")
	public static final Block block = null;

	public IrontilestairBlock(OcmModElements instance) {
		super(instance, 1068);
	}
