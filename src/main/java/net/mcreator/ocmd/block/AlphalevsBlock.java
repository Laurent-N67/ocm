...
public class AlphalevsBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:alphalevs")
	public static final Block block = null;

	public AlphalevsBlock(OcmModElements instance) {
		super(instance, 489);
	}
