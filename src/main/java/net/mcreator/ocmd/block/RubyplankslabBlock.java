...
public class RubyplankslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:rubyplankslab")
	public static final Block block = null;

	public RubyplankslabBlock(OcmModElements instance) {
		super(instance, 2270);
	}
