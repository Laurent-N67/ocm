...
public class PlankacaciaghostBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:plankacaciaghost")
	public static final Block block = null;

	public PlankacaciaghostBlock(OcmModElements instance) {
		super(instance, 963);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("plankacaciaghost");
		}
