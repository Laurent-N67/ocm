...
public class RitualdarkBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ritualdark")
	public static final Block block = null;

	public RitualdarkBlock(OcmModElements instance) {
		super(instance, 785);
	}
