...
public class Dungeoniceslide2Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeoniceslide_2")
	public static final Block block = null;

	public Dungeoniceslide2Block(OcmModElements instance) {
		super(instance, 1327);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.GLASS).sound(SoundType.GLASS).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 0)
					.slipperiness(1.8f));
			setRegistryName("dungeoniceslide_2");
		}
