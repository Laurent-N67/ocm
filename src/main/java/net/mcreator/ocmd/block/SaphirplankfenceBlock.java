...
public class SaphirplankfenceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:saphirplankfence")
	public static final Block block = null;

	public SaphirplankfenceBlock(OcmModElements instance) {
		super(instance, 2275);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("saphirplankfence");
		}
