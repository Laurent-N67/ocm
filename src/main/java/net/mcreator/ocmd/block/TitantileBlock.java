...
public class TitantileBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:titantile")
	public static final Block block = null;

	public TitantileBlock(OcmModElements instance) {
		super(instance, 2183);
	}
