...
public class CitrinebricksBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:citrinebricks")
	public static final Block block = null;

	public CitrinebricksBlock(OcmModElements instance) {
		super(instance, 1009);
	}
