...
public class CopperplankBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:copperplank")
	public static final Block block = null;

	public CopperplankBlock(OcmModElements instance) {
		super(instance, 2244);
	}
