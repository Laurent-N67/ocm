...
public class PlankghostBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:plankghost")
	public static final Block block = null;

	public PlankghostBlock(OcmModElements instance) {
		super(instance, 958);
	}
