...
public class GridblocsbBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:gridblocsb")
	public static final Block block = null;

	public GridblocsbBlock(OcmModElements instance) {
		super(instance, 446);
	}
