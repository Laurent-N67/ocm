...
public class BarreloakBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:barreloak")
	public static final Block block = null;

	public BarreloakBlock(OcmModElements instance) {
		super(instance, 835);
	}
