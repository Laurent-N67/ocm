...
public class SingletabledarkoakBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:singletabledarkoak")
	public static final Block block = null;

	public SingletabledarkoakBlock(OcmModElements instance) {
		super(instance, 742);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("singletabledarkoak");
		}
