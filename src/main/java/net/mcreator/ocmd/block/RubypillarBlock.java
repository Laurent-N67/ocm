...
public class RubypillarBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:rubypillar")
	public static final Block block = null;

	public RubypillarBlock(OcmModElements instance) {
		super(instance, 2133);
	}
