...
public class Dungeonpillar1Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonpillar_1")
	public static final Block block = null;

	public Dungeonpillar1Block(OcmModElements instance) {
		super(instance, 1310);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dungeonpillar_1");
		}
