...
public class Chiseledstone2Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:chiseledstone_2")
	public static final Block block = null;

	public Chiseledstone2Block(OcmModElements instance) {
		super(instance, 721);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseledstone_2");
		}
