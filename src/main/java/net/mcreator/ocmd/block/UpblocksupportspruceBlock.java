...
public class UpblocksupportspruceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:upblocksupportspruce")
	public static final Block block = null;

	public UpblocksupportspruceBlock(OcmModElements instance) {
		super(instance, 771);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("upblocksupportspruce");
		}
