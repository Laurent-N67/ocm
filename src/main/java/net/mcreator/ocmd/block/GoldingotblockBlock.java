...
public class GoldingotblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:goldingotblock")
	public static final Block block = null;

	public GoldingotblockBlock(OcmModElements instance) {
		super(instance, 1033);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("goldingotblock");
		}
