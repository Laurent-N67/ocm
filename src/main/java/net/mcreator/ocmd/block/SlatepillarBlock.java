...
public class SlatepillarBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:slatepillar")
	public static final Block block = null;

	public SlatepillarBlock(OcmModElements instance) {
		super(instance, 2155);
	}
