...
public class Plantoa7Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:plantoa_7")
	public static final Block block = null;

	public Plantoa7Block(OcmModElements instance) {
		super(instance, 1144);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("plantoa_7"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ocm:plantoa_7"), configuredFeature);
		}
	}
