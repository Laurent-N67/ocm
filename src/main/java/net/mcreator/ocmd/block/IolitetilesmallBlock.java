...
public class IolitetilesmallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:iolitetilesmall")
	public static final Block block = null;

	public IolitetilesmallBlock(OcmModElements instance) {
		super(instance, 1051);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("iolitetilesmall");
		}
