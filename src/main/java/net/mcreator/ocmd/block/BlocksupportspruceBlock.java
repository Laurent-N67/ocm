...
public class BlocksupportspruceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:blocksupportspruce")
	public static final Block block = null;

	public BlocksupportspruceBlock(OcmModElements instance) {
		super(instance, 765);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("blocksupportspruce");
		}
