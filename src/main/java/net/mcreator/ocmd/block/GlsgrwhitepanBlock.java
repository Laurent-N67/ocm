...
public class GlsgrwhitepanBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:glsgrwhitepan")
	public static final Block block = null;

	public GlsgrwhitepanBlock(OcmModElements instance) {
		super(instance, 952);
	}
