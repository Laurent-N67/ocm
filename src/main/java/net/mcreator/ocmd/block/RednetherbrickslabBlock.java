...
public class RednetherbrickslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:rednetherbrickslab")
	public static final Block block = null;

	public RednetherbrickslabBlock(OcmModElements instance) {
		super(instance, 711);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("rednetherbrickslab");
		}
