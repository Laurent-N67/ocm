...
public class SaphirlogBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:saphirlog")
	public static final Block block = null;

	public SaphirlogBlock(OcmModElements instance) {
		super(instance, 2231);
	}
