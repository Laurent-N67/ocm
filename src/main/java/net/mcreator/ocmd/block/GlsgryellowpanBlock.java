...
public class GlsgryellowpanBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:glsgryellowpan")
	public static final Block block = null;

	public GlsgryellowpanBlock(OcmModElements instance) {
		super(instance, 949);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("glsgryellowpan");
		}
