...
public class PalmplankBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:palmplank")
	public static final Block block = null;

	public PalmplankBlock(OcmModElements instance) {
		super(instance, 2264);
	}
