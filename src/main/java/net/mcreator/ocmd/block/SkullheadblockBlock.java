...
public class SkullheadblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:skullheadblock")
	public static final Block block = null;

	public SkullheadblockBlock(OcmModElements instance) {
		super(instance, 2518);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("skullheadblock");
		}
