...
public class CopperplankstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:copperplankstair")
	public static final Block block = null;

	public CopperplankstairBlock(OcmModElements instance) {
		super(instance, 2245);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("copperplankstair");
		}
