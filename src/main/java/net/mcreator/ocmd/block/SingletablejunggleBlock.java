...
public class SingletablejunggleBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:singletablejunggle")
	public static final Block block = null;

	public SingletablejunggleBlock(OcmModElements instance) {
		super(instance, 740);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("singletablejunggle");
		}
