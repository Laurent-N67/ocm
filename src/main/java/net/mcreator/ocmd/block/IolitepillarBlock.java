...
public class IolitepillarBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:iolitepillar")
	public static final Block block = null;

	public IolitepillarBlock(OcmModElements instance) {
		super(instance, 1048);
	}
