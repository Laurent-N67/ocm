...
public class WavechiselstoneBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:wavechiselstone")
	public static final Block block = null;

	public WavechiselstoneBlock(OcmModElements instance) {
		super(instance, 955);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("wavechiselstone");
		}
