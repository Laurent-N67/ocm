...
public class RdstlponBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:rdstlpon")
	public static final Block block = null;

	public RdstlponBlock(OcmModElements instance) {
		super(instance, 583);
	}
