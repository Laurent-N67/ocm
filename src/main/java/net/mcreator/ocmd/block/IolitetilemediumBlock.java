...
public class IolitetilemediumBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:iolitetilemedium")
	public static final Block block = null;

	public IolitetilemediumBlock(OcmModElements instance) {
		super(instance, 1052);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("iolitetilemedium");
		}
