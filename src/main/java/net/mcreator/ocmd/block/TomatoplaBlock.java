...
public class TomatoplaBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:tomatopla")
	public static final Block block = null;

	public TomatoplaBlock(OcmModElements instance) {
		super(instance, 1134);
	}
