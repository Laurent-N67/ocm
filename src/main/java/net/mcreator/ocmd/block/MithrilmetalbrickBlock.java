...
public class MithrilmetalbrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:mithrilmetalbrick")
	public static final Block block = null;

	public MithrilmetalbrickBlock(OcmModElements instance) {
		super(instance, 1098);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("mithrilmetalbrick");
		}
