...
public class EndplankslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:endplankslab")
	public static final Block block = null;

	public EndplankslabBlock(OcmModElements instance) {
		super(instance, 2254);
	}
