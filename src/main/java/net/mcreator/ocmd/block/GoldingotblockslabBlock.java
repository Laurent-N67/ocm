...
public class GoldingotblockslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:goldingotblockslab")
	public static final Block block = null;

	public GoldingotblockslabBlock(OcmModElements instance) {
		super(instance, 1035);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("goldingotblockslab");
		}
