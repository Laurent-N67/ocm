...
public class KyaniteweaverBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:kyaniteweaver")
	public static final Block block = null;

	public KyaniteweaverBlock(OcmModElements instance) {
		super(instance, 1078);
	}
