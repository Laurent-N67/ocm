...
public class SlateOreBlockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:slate_ore_block")
	public static final Block block = null;

	public SlateOreBlockBlock(OcmModElements instance) {
		super(instance, 388);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("slate_ore_block");
		}
