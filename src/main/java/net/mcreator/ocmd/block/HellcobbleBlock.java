...
public class HellcobbleBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:hellcobble")
	public static final Block block = null;

	public HellcobbleBlock(OcmModElements instance) {
		super(instance, 880);
	}
