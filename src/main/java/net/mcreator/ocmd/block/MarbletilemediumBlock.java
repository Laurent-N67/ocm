...
public class MarbletilemediumBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:marbletilemedium")
	public static final Block block = null;

	public MarbletilemediumBlock(OcmModElements instance) {
		super(instance, 1089);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletilemedium");
		}
