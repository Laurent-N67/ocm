...
public class IrontileBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:irontile")
	public static final Block block = null;

	public IrontileBlock(OcmModElements instance) {
		super(instance, 1067);
	}
