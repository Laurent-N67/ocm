...
public class TopazpillarBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:topazpillar")
	public static final Block block = null;

	public TopazpillarBlock(OcmModElements instance) {
		super(instance, 2188);
	}
