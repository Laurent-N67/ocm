...
public class SlbwoolprpBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:slbwoolprp")
	public static final Block block = null;

	public SlbwoolprpBlock(OcmModElements instance) {
		super(instance, 414);
	}
