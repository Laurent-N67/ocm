...
public class DalleupbrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dalleupbrick")
	public static final Block block = null;

	public DalleupbrickBlock(OcmModElements instance) {
		super(instance, 751);
	}
