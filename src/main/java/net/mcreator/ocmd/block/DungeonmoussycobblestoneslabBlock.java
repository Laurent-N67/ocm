...
public class DungeonmoussycobblestoneslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonmoussycobblestoneslab")
	public static final Block block = null;

	public DungeonmoussycobblestoneslabBlock(OcmModElements instance) {
		super(instance, 1348);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dungeonmoussycobblestoneslab");
		}
