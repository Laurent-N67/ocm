...
public class LpilpistBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:lpilpist")
	public static final Block block = null;

	public LpilpistBlock(OcmModElements instance) {
		super(instance, 497);
	}
