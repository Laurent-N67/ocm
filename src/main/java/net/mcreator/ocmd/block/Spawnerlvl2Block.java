...
import net.mcreator.ocmd.procedures.Spawnerlvl2MiseAJourDuTickProcedure;
...
public class Spawnerlvl2Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:spawnerlvl_2")
	public static final Block block = null;

	public Spawnerlvl2Block(OcmModElements instance) {
		super(instance, 868);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			Spawnerlvl2MiseAJourDuTickProcedure.executeProcedure(Stream
