...
public class AquastonebrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:aquastonebrick")
	public static final Block block = null;

	public AquastonebrickBlock(OcmModElements instance) {
		super(instance, 797);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aquastonebrick");
		}
