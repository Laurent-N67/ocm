...
public class Chisbk3Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:chisbk_3")
	public static final Block block = null;

	public Chisbk3Block(OcmModElements instance) {
		super(instance, 616);
	}
