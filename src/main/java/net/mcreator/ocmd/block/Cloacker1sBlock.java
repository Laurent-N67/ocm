...
import net.mcreator.ocmd.procedures.Cloacker1sMiseAJourDuTickProcedure;
...
public class Cloacker1sBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:cloacker_1s")
	public static final Block block = null;

	public Cloacker1sBlock(OcmModElements instance) {
		super(instance, 893);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			Cloacker1sMiseAJourDuTickProcedure.executeProcedure(Stream
