...
public class DalleupstoneBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dalleupstone")
	public static final Block block = null;

	public DalleupstoneBlock(OcmModElements instance) {
		super(instance, 749);
	}
