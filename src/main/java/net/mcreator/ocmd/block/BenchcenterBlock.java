...
public class BenchcenterBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:benchcenter")
	public static final Block block = null;

	public BenchcenterBlock(OcmModElements instance) {
		super(instance, 842);
	}
