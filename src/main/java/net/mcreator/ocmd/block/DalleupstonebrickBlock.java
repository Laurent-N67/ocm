...
public class DalleupstonebrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dalleupstonebrick")
	public static final Block block = null;

	public DalleupstonebrickBlock(OcmModElements instance) {
		super(instance, 750);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("dalleupstonebrick");
		}
