...
public class GoldsmoothBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:goldsmooth")
	public static final Block block = null;

	public GoldsmoothBlock(OcmModElements instance) {
		super(instance, 1039);
	}
