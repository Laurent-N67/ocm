...
public class DungeonstonebrickghostBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonstonebrickghost")
	public static final Block block = null;

	public DungeonstonebrickghostBlock(OcmModElements instance) {
		super(instance, 1329);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dungeonstonebrickghost");
		}
