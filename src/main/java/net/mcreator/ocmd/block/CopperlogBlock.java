...
public class CopperlogBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:copperlog")
	public static final Block block = null;

	public CopperlogBlock(OcmModElements instance) {
		super(instance, 2224);
	}
