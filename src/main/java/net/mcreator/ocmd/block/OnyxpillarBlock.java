...
public class OnyxpillarBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:onyxpillar")
	public static final Block block = null;

	public OnyxpillarBlock(OcmModElements instance) {
		super(instance, 2199);
	}
