...
public class Chisst5Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:chisst_5")
	public static final Block block = null;

	public Chisst5Block(OcmModElements instance) {
		super(instance, 615);
	}
