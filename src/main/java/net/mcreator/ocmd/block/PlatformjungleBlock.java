...
public class PlatformjungleBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:platformjungle")
	public static final Block block = null;

	public PlatformjungleBlock(OcmModElements instance) {
		super(instance, 778);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("platformjungle");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(0, 12.799999999999999, 0, 16, 16, 16)
