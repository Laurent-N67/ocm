...
public class GoldplankBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:goldplank")
	public static final Block block = null;

	public GoldplankBlock(OcmModElements instance) {
		super(instance, 2260);
	}
