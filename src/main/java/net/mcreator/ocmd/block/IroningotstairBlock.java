...
public class IroningotstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ironingotstair")
	public static final Block block = null;

	public IroningotstairBlock(OcmModElements instance) {
		super(instance, 1059);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("ironingotstair");
		}
