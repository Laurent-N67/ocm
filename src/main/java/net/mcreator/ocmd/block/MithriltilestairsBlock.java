...
public class MithriltilestairsBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:mithriltilestairs")
	public static final Block block = null;

	public MithriltilestairsBlock(OcmModElements instance) {
		super(instance, 1105);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("mithriltilestairs");
		}
