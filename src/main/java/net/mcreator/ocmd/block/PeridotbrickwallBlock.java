...
public class PeridotbrickwallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:peridotbrickwall")
	public static final Block block = null;

	public PeridotbrickwallBlock(OcmModElements instance) {
		super(instance, 2219);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("peridotbrickwall");
		}
