...
public class JpplanksBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:jpplanks")
	public static final Block block = null;

	public JpplanksBlock(OcmModElements instance) {
		super(instance, 462);
	}
