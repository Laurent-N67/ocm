...
public class GrklgpilBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:grklgpil")
	public static final Block block = null;

	public GrklgpilBlock(OcmModElements instance) {
		super(instance, 579);
	}
