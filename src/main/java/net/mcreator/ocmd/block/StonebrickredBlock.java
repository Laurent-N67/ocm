...
public class StonebrickredBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:stonebrickred")
	public static final Block block = null;

	public StonebrickredBlock(OcmModElements instance) {
		super(instance, 568);
	}
