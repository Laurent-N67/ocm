...
public class TitantileslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:titantileslab")
	public static final Block block = null;

	public TitantileslabBlock(OcmModElements instance) {
		super(instance, 2185);
	}
