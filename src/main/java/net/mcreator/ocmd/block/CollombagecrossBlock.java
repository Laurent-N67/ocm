...
public class CollombagecrossBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:collombagecross")
	public static final Block block = null;

	public CollombagecrossBlock(OcmModElements instance) {
		super(instance, 384);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("collombagecross");
		}
