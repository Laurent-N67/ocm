...
public class TitanemetalbrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:titanemetalbrick")
	public static final Block block = null;

	public TitanemetalbrickBlock(OcmModElements instance) {
		super(instance, 2177);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("titanemetalbrick");
		}
