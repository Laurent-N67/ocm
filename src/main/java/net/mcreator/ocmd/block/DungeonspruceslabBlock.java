...
public class DungeonspruceslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonspruceslab")
	public static final Block block = null;

	public DungeonspruceslabBlock(OcmModElements instance) {
		super(instance, 1322);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dungeonspruceslab");
		}
