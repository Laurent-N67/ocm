...
public class DungeonpillardownBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonpillardown")
	public static final Block block = null;

	public DungeonpillardownBlock(OcmModElements instance) {
		super(instance, 902);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dungeonpillardown");
		}
