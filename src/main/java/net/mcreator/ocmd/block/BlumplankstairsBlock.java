...
public class BlumplankstairsBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:blumplankstairs")
	public static final Block block = null;

	public BlumplankstairsBlock(OcmModElements instance) {
		super(instance, 2233);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("blumplankstairs");
		}
