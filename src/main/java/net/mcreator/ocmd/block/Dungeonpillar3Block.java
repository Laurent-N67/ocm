...
public class Dungeonpillar3Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonpillar_3")
	public static final Block block = null;

	public Dungeonpillar3Block(OcmModElements instance) {
		super(instance, 1312);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dungeonpillar_3");
		}
