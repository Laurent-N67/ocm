...
import net.mcreator.ocmd.procedures.WnstgUpdateTickProcedure;
...
public class WnstgBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:wnstg")
	public static final Block block = null;

	public WnstgBlock(OcmModElements instance) {
		super(instance, 476);
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			WnstgUpdateTickProcedure.executeProcedure(Stream
