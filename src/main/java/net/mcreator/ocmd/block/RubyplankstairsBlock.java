...
public class RubyplankstairsBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:rubyplankstairs")
	public static final Block block = null;

	public RubyplankstairsBlock(OcmModElements instance) {
		super(instance, 2269);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("rubyplankstairs");
		}
