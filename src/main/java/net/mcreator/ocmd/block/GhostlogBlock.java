...
public class GhostlogBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ghostlog")
	public static final Block block = null;

	public GhostlogBlock(OcmModElements instance) {
		super(instance, 2227);
	}
