...
public class RubybrickwallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:rubybrickwall")
	public static final Block block = null;

	public RubybrickwallBlock(OcmModElements instance) {
		super(instance, 2213);
	}
