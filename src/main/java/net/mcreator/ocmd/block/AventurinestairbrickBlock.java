...
public class AventurinestairbrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:aventurinestairbrick")
	public static final Block block = null;

	public AventurinestairbrickBlock(OcmModElements instance) {
		super(instance, 1006);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("aventurinestairbrick");
		}
