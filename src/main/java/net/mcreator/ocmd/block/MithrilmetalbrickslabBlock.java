...
public class MithrilmetalbrickslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:mithrilmetalbrickslab")
	public static final Block block = null;

	public MithrilmetalbrickslabBlock(OcmModElements instance) {
		super(instance, 1100);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("mithrilmetalbrickslab");
		}
