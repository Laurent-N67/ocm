...
public class BlumplankBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:blumplank")
	public static final Block block = null;

	public BlumplankBlock(OcmModElements instance) {
		super(instance, 2232);
	}
