...
public class CrfslateBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:crfslate")
	public static final Block block = null;

	public CrfslateBlock(OcmModElements instance) {
		super(instance, 505);
	}
