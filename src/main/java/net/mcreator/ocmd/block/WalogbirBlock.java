...
public class WalogbirBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:walogbir")
	public static final Block block = null;

	public WalogbirBlock(OcmModElements instance) {
		super(instance, 629);
	}
