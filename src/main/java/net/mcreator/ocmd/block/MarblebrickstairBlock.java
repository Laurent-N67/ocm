...
public class MarblebrickstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:marblebrickstair")
	public static final Block block = null;

	public MarblebrickstairBlock(OcmModElements instance) {
		super(instance, 1093);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("marblebrickstair");
		}
