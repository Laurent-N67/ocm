...
public class DungeoncrackedstonebrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeoncrackedstonebrick")
	public static final Block block = null;

	public DungeoncrackedstonebrickBlock(OcmModElements instance) {
		super(instance, 1332);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dungeoncrackedstonebrick");
		}
