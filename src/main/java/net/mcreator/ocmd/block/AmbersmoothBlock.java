...
public class AmbersmoothBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ambersmooth")
	public static final Block block = null;

	public AmbersmoothBlock(OcmModElements instance) {
		super(instance, 988);
	}
