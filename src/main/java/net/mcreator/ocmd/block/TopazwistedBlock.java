...
public class TopazwistedBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:topazwisted")
	public static final Block block = null;

	public TopazwistedBlock(OcmModElements instance) {
		super(instance, 2194);
	}
