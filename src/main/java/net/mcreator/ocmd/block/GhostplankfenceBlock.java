...
public class GhostplankfenceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ghostplankfence")
	public static final Block block = null;

	public GhostplankfenceBlock(OcmModElements instance) {
		super(instance, 2259);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("ghostplankfence");
		}
