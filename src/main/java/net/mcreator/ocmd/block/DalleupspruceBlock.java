...
public class DalleupspruceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dalleupspruce")
	public static final Block block = null;

	public DalleupspruceBlock(OcmModElements instance) {
		super(instance, 745);
	}
