...
public class BedrockbreakerBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:bedrockbreaker")
	public static final Block block = null;

	public BedrockbreakerBlock(OcmModElements instance) {
		super(instance, 932);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bedrockbreaker");
		}
