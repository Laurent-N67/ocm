...
public class TopazbrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:topazbrick")
	public static final Block block = null;

	public TopazbrickBlock(OcmModElements instance) {
		super(instance, 2186);
	}
