...
public class DarkprismstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:darkprismstair")
	public static final Block block = null;

	public DarkprismstairBlock(OcmModElements instance) {
		super(instance, 710);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("darkprismstair");
		}
