...
public class Dungeonglass1Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonglass_1")
	public static final Block block = null;

	public Dungeonglass1Block(OcmModElements instance) {
		super(instance, 1340);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dungeonglass_1");
		}
