...
public class OnyxbrickwallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:onyxbrickwall")
	public static final Block block = null;

	public OnyxbrickwallBlock(OcmModElements instance) {
		super(instance, 2218);
	}
