...
public class HugebenchspruceleftBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:hugebenchspruceleft")
	public static final Block block = null;

	public HugebenchspruceleftBlock(OcmModElements instance) {
		super(instance, 851);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("hugebenchspruceleft");
		}
