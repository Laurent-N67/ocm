...
public class OnyxtilemediumBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:onyxtilemedium")
	public static final Block block = null;

	public OnyxtilemediumBlock(OcmModElements instance) {
		super(instance, 2202);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("onyxtilemedium");
		}
