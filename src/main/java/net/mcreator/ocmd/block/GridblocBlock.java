...
public class GridblocBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:gridbloc")
	public static final Block block = null;

	public GridblocBlock(OcmModElements instance) {
		super(instance, 444);
	}
