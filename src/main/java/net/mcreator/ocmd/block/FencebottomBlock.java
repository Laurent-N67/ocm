...
public class FencebottomBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:fencebottom")
	public static final Block block = null;

	public FencebottomBlock(OcmModElements instance) {
		super(instance, 978);
	}
