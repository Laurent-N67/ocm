...
public class PeridotwistedBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:peridotwisted")
	public static final Block block = null;

	public PeridotwistedBlock(OcmModElements instance) {
		super(instance, 1127);
	}
