...
public class Plantoa6Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:plantoa_6")
	public static final Block block = null;

	public Plantoa6Block(OcmModElements instance) {
		super(instance, 1143);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("plantoa_6"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ocm:plantoa_6"), configuredFeature);
		}
	}
