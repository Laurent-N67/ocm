...
public class CitrineplankslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:citrineplankslab")
	public static final Block block = null;

	public CitrineplankslabBlock(OcmModElements instance) {
		super(instance, 2242);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("citrineplankslab");
		}
