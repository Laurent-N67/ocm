...
public class AmberOreBlockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:amber_ore_block")
	public static final Block block = null;

	public AmberOreBlockBlock(OcmModElements instance) {
		super(instance, 426);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("amber_ore_block");
		}
