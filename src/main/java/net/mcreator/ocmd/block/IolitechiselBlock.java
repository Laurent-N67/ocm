...
public class IolitechiselBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:iolitechisel")
	public static final Block block = null;

	public IolitechiselBlock(OcmModElements instance) {
		super(instance, 1050);
	}
