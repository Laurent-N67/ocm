...
public class AmberpillarBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:amberpillar")
	public static final Block block = null;

	public AmberpillarBlock(OcmModElements instance) {
		super(instance, 987);
	}
