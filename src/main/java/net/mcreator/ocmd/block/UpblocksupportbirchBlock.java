...
public class UpblocksupportbirchBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:upblocksupportbirch")
	public static final Block block = null;

	public UpblocksupportbirchBlock(OcmModElements instance) {
		super(instance, 770);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("upblocksupportbirch");
		}
