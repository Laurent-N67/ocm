...
public class SaphirbrickstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:saphirbrickstair")
	public static final Block block = null;

	public SaphirbrickstairBlock(OcmModElements instance) {
		super(instance, 2151);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("saphirbrickstair");
		}
