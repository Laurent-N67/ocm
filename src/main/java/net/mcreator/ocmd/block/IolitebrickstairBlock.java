...
public class IolitebrickstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:iolitebrickstair")
	public static final Block block = null;

	public IolitebrickstairBlock(OcmModElements instance) {
		super(instance, 1055);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("iolitebrickstair");
		}
