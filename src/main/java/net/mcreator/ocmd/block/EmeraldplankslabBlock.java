...
public class EmeraldplankslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:emeraldplankslab")
	public static final Block block = null;

	public EmeraldplankslabBlock(OcmModElements instance) {
		super(instance, 2250);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("emeraldplankslab");
		}
