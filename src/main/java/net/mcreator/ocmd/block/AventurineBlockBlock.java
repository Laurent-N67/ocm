...
public class AventurineBlockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:aventurine_block")
	public static final Block block = null;

	public AventurineBlockBlock(OcmModElements instance) {
		super(instance, 799);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aventurine_block");
		}
