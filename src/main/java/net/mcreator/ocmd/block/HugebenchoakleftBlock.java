...
public class HugebenchoakleftBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:hugebenchoakleft")
	public static final Block block = null;

	public HugebenchoakleftBlock(OcmModElements instance) {
		super(instance, 845);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("hugebenchoakleft");
		}
