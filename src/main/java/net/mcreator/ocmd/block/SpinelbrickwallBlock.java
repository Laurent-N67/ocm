...
public class SpinelbrickwallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:spinelbrickwall")
	public static final Block block = null;

	public SpinelbrickwallBlock(OcmModElements instance) {
		super(instance, 2216);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("spinelbrickwall");
		}
