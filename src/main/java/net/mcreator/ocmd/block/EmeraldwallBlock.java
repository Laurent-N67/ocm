...
public class EmeraldwallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:emeraldwall")
	public static final Block block = null;

	public EmeraldwallBlock(OcmModElements instance) {
		super(instance, 1032);
	}
