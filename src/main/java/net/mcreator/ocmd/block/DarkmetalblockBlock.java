...
public class DarkmetalblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:darkmetalblock")
	public static final Block block = null;

	public DarkmetalblockBlock(OcmModElements instance) {
		super(instance, 715);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("darkmetalblock");
		}
