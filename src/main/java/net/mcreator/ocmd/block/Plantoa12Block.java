...
public class Plantoa12Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:plantoa_12")
	public static final Block block = null;

	public Plantoa12Block(OcmModElements instance) {
		super(instance, 1149);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("plantoa_12"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ocm:plantoa_12"), configuredFeature);
		}
	}
