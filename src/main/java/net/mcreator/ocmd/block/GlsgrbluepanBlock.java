...
public class GlsgrbluepanBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:glsgrbluepan")
	public static final Block block = null;

	public GlsgrbluepanBlock(OcmModElements instance) {
		super(instance, 946);
	}
