...
public class NacrebrickwallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:nacrebrickwall")
	public static final Block block = null;

	public NacrebrickwallBlock(OcmModElements instance) {
		super(instance, 2220);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("nacrebrickwall");
		}
