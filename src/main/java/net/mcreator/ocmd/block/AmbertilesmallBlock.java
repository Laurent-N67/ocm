...
public class AmbertilesmallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ambertilesmall")
	public static final Block block = null;

	public AmbertilesmallBlock(OcmModElements instance) {
		super(instance, 991);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ambertilesmall");
		}
