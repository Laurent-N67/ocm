...
public class RubybrickstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:rubybrickstair")
	public static final Block block = null;

	public RubybrickstairBlock(OcmModElements instance) {
		super(instance, 2140);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("rubybrickstair");
		}
