...
public class LpilstbrBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:lpilstbr")
	public static final Block block = null;

	public LpilstbrBlock(OcmModElements instance) {
		super(instance, 502);
	}
