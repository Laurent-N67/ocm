...
public class AventurinepillarBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:aventurinepillar")
	public static final Block block = null;

	public AventurinepillarBlock(OcmModElements instance) {
		super(instance, 999);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aventurinepillar");
		}
