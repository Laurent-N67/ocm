...
public class TopazweaverBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:topazweaver")
	public static final Block block = null;

	public TopazweaverBlock(OcmModElements instance) {
		super(instance, 2193);
	}
