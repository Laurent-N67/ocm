...
public class DungeonoakslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonoakslab")
	public static final Block block = null;

	public DungeonoakslabBlock(OcmModElements instance) {
		super(instance, 1319);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dungeonoakslab");
		}
