...
public class NacrebrickslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:nacrebrickslab")
	public static final Block block = null;

	public NacrebrickslabBlock(OcmModElements instance) {
		super(instance, 1118);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("nacrebrickslab");
		}
