...
public class SaphirbrickwallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:saphirbrickwall")
	public static final Block block = null;

	public SaphirbrickwallBlock(OcmModElements instance) {
		super(instance, 2214);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("saphirbrickwall");
		}
