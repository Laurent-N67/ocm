...
public class NordicportalblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:nordicportalblock")
	public static final Block block = null;

	public NordicportalblockBlock(OcmModElements instance) {
		super(instance, 890);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("nordicportalblock");
		}
