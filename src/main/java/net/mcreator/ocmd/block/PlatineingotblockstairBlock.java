...
public class PlatineingotblockstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:platineingotblockstair")
	public static final Block block = null;

	public PlatineingotblockstairBlock(OcmModElements instance) {
		super(instance, 2123);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("platineingotblockstair");
		}
