...
public class DungeonglassblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonglassblock")
	public static final Block block = null;

	public DungeonglassblockBlock(OcmModElements instance) {
		super(instance, 1306);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dungeonglassblock");
		}
