...
public class EndplankBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:endplank")
	public static final Block block = null;

	public EndplankBlock(OcmModElements instance) {
		super(instance, 2252);
	}
