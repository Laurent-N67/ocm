...
public class CitrineplankstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:citrineplankstair")
	public static final Block block = null;

	public CitrineplankstairBlock(OcmModElements instance) {
		super(instance, 2241);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("citrineplankstair");
		}
