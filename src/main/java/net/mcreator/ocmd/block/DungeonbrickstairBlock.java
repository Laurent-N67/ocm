...
public class DungeonbrickstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonbrickstair")
	public static final Block block = null;

	public DungeonbrickstairBlock(OcmModElements instance) {
		super(instance, 1338);
	}
		...
		public CustomBlock() {
			super(() -> new Block(
					Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 0))
							.getDefaultState(),
					Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 0));
			setRegistryName("dungeonbrickstair");
		}
