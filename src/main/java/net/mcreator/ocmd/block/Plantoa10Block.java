...
public class Plantoa10Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:plantoa_10")
	public static final Block block = null;

	public Plantoa10Block(OcmModElements instance) {
		super(instance, 1147);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("plantoa_10"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ocm:plantoa_10"), configuredFeature);
		}
	}
