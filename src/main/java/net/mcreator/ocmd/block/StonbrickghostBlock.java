...
public class StonbrickghostBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:stonbrickghost")
	public static final Block block = null;

	public StonbrickghostBlock(OcmModElements instance) {
		super(instance, 966);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stonbrickghost");
		}
