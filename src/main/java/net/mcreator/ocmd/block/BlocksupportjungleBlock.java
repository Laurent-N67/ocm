...
public class BlocksupportjungleBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:blocksupportjungle")
	public static final Block block = null;

	public BlocksupportjungleBlock(OcmModElements instance) {
		super(instance, 767);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("blocksupportjungle");
		}
