...
public class HugebenchbirchrightBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:hugebenchbirchright")
	public static final Block block = null;

	public HugebenchbirchrightBlock(OcmModElements instance) {
		super(instance, 850);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("hugebenchbirchright");
		}
