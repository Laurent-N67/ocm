...
public class BlocksupportdarkoakBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:blocksupportdarkoak")
	public static final Block block = null;

	public BlocksupportdarkoakBlock(OcmModElements instance) {
		super(instance, 768);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("blocksupportdarkoak");
		}
