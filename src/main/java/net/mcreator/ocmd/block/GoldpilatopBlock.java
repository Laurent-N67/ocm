...
public class GoldpilatopBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:goldpilatop")
	public static final Block block = null;

	public GoldpilatopBlock(OcmModElements instance) {
		super(instance, 877);
	}
