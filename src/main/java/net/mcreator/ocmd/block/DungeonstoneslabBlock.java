...
public class DungeonstoneslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonstoneslab")
	public static final Block block = null;

	public DungeonstoneslabBlock(OcmModElements instance) {
		super(instance, 1300);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dungeonstoneslab");
		}
