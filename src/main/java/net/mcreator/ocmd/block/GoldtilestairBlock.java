...
public class GoldtilestairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:goldtilestair")
	public static final Block block = null;

	public GoldtilestairBlock(OcmModElements instance) {
		super(instance, 1043);
	}
