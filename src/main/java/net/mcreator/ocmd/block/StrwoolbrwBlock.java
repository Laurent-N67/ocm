...
public class StrwoolbrwBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:strwoolbrw")
	public static final Block block = null;

	public StrwoolbrwBlock(OcmModElements instance) {
		super(instance, 405);
	}
