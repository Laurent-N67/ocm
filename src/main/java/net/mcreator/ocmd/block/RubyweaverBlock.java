...
public class RubyweaverBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:rubyweaver")
	public static final Block block = null;

	public RubyweaverBlock(OcmModElements instance) {
		super(instance, 2138);
	}
