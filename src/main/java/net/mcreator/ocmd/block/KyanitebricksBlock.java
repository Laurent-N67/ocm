...
public class KyanitebricksBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:kyanitebricks")
	public static final Block block = null;

	public KyanitebricksBlock(OcmModElements instance) {
		super(instance, 1071);
	}
