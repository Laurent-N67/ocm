...
public class StrwoolgreBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:strwoolgre")
	public static final Block block = null;

	public StrwoolgreBlock(OcmModElements instance) {
		super(instance, 401);
	}
