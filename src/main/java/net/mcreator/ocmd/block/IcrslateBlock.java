...
public class IcrslateBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:icrslate")
	public static final Block block = null;

	public IcrslateBlock(OcmModElements instance) {
		super(instance, 523);
	}
