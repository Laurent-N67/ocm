...
public class IcrscyanBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:icrscyan")
	public static final Block block = null;

	public IcrscyanBlock(OcmModElements instance) {
		super(instance, 526);
	}
