...
public class StbmoussyBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:stbmoussy")
	public static final Block block = null;

	public StbmoussyBlock(OcmModElements instance) {
		super(instance, 593);
	}
