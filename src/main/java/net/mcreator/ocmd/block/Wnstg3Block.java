...
import net.mcreator.ocmd.procedures.Wnstg3UpdateTickProcedure;
...
public class Wnstg3Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:wnstg_3")
	public static final Block block = null;

	public Wnstg3Block(OcmModElements instance) {
		super(instance, 574);
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			Wnstg3UpdateTickProcedure.executeProcedure(Stream
