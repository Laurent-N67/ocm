...
public class VineplantBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:vineplant")
	public static final Block block = null;

	public VineplantBlock(OcmModElements instance) {
		super(instance, 1131);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("vineplant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ocm:vineplant"), configuredFeature);
		}
	}
