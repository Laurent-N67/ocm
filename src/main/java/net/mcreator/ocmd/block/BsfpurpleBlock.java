...
public class BsfpurpleBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:bsfpurple")
	public static final Block block = null;

	public BsfpurpleBlock(OcmModElements instance) {
		super(instance, 671);
	}
