...
public class SpinelchiselBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:spinelchisel")
	public static final Block block = null;

	public SpinelchiselBlock(OcmModElements instance) {
		super(instance, 2167);
	}
