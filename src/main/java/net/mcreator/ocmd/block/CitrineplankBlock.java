...
public class CitrineplankBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:citrineplank")
	public static final Block block = null;

	public CitrineplankBlock(OcmModElements instance) {
		super(instance, 2240);
	}
