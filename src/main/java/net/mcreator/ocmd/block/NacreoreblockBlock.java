...
public class NacreoreblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:nacreoreblock")
	public static final Block block = null;

	public NacreoreblockBlock(OcmModElements instance) {
		super(instance, 1109);
	}
