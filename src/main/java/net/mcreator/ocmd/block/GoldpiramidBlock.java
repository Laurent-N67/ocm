...
public class GoldpiramidBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:goldpiramid")
	public static final Block block = null;

	public GoldpiramidBlock(OcmModElements instance) {
		super(instance, 876);
	}
