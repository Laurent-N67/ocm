...
public class PeridotbrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:peridotbrick")
	public static final Block block = null;

	public PeridotbrickBlock(OcmModElements instance) {
		super(instance, 1119);
	}
