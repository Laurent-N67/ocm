...
public class NacrepillarBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:nacrepillar")
	public static final Block block = null;

	public NacrepillarBlock(OcmModElements instance) {
		super(instance, 1110);
	}
