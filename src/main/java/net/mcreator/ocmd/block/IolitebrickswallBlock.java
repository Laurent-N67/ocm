...
public class IolitebrickswallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:iolitebrickswall")
	public static final Block block = null;

	public IolitebrickswallBlock(OcmModElements instance) {
		super(instance, 1057);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("iolitebrickswall");
		}
