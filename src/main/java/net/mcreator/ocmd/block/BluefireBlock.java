...
public class BluefireBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:bluefire")
	public static final Block block = null;

	public BluefireBlock(OcmModElements instance) {
		super(instance, 608);
	}
