...
public class GhostplankstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ghostplankstair")
	public static final Block block = null;

	public GhostplankstairBlock(OcmModElements instance) {
		super(instance, 2257);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("ghostplankstair");
		}
