...
public class WalogsprBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:walogspr")
	public static final Block block = null;

	public WalogsprBlock(OcmModElements instance) {
		super(instance, 628);
	}
