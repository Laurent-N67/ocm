...
public class Dungeoniceslide3Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeoniceslide_3")
	public static final Block block = null;

	public Dungeoniceslide3Block(OcmModElements instance) {
		super(instance, 1328);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.GLASS).sound(SoundType.GLASS).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 0)
					.slipperiness(2.5f));
			setRegistryName("dungeoniceslide_3");
		}
