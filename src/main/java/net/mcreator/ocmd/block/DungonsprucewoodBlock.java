...
public class DungonsprucewoodBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungonsprucewood")
	public static final Block block = null;

	public DungonsprucewoodBlock(OcmModElements instance) {
		super(instance, 1352);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("dungonsprucewood");
		}
