...
import net.mcreator.ocmd.procedures.SlotmachineeLorsDunClicDroitSurLeBlocProcedure;
...
public class SlotmachineeBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:slotmachinee")
	public static final Block block = null;

	public SlotmachineeBlock(OcmModElements instance) {
		super(instance, 945);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			SlotmachineeLorsDunClicDroitSurLeBlocProcedure.executeProcedure(Stream
