...
public class RitualwhiteBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ritualwhite")
	public static final Block block = null;

	public RitualwhiteBlock(OcmModElements instance) {
		super(instance, 784);
	}
