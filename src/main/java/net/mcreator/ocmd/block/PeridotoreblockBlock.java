...
public class PeridotoreblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:peridotoreblock")
	public static final Block block = null;

	public PeridotoreblockBlock(OcmModElements instance) {
		super(instance, 1120);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("peridotoreblock");
		}
