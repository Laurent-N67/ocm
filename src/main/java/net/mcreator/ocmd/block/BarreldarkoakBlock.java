...
public class BarreldarkoakBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:barreldarkoak")
	public static final Block block = null;

	public BarreldarkoakBlock(OcmModElements instance) {
		super(instance, 833);
	}
