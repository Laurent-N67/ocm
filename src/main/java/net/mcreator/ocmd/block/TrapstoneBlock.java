...
public class TrapstoneBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:trapstone")
	public static final Block block = null;

	public TrapstoneBlock(OcmModElements instance) {
		super(instance, 480);
	}
