...
public class SlatebrickstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:slatebrickstair")
	public static final Block block = null;

	public SlatebrickstairBlock(OcmModElements instance) {
		super(instance, 2161);
	}
