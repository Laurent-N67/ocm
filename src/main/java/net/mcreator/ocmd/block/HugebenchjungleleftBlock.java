...
public class HugebenchjungleleftBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:hugebenchjungleleft")
	public static final Block block = null;

	public HugebenchjungleleftBlock(OcmModElements instance) {
		super(instance, 854);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("hugebenchjungleleft");
		}
