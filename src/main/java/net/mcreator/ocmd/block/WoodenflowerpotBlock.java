...
public class WoodenflowerpotBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:woodenflowerpot")
	public static final Block block = null;

	public WoodenflowerpotBlock(OcmModElements instance) {
		super(instance, 896);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("woodenflowerpot");
		}
