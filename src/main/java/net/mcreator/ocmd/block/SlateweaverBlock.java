...
public class SlateweaverBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:slateweaver")
	public static final Block block = null;

	public SlateweaverBlock(OcmModElements instance) {
		super(instance, 2159);
	}
