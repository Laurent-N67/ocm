...
public class WorldfarmfarmaBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:worldfarmfarma")
	public static final Block block = null;

	public WorldfarmfarmaBlock(OcmModElements instance) {
		super(instance, 542);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("worldfarmfarma");
		}
