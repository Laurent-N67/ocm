...
public class PlankbirchghostBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:plankbirchghost")
	public static final Block block = null;

	public PlankbirchghostBlock(OcmModElements instance) {
		super(instance, 961);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("plankbirchghost");
		}
