...
public class PlatinesmoothBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:platinesmooth")
	public static final Block block = null;

	public PlatinesmoothBlock(OcmModElements instance) {
		super(instance, 2208);
	}
