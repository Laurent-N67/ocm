...
import net.mcreator.ocmd.gui.CrateguiGui;
...
public class CrateBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:crate")
	public static final Block block = null;
	@ObjectHolder("ocm:crate")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public CrateBlock(OcmModElements instance) {
		super(instance, 754);
