...
public class CitrinelogBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:citrinelog")
	public static final Block block = null;

	public CitrinelogBlock(OcmModElements instance) {
		super(instance, 2223);
	}
