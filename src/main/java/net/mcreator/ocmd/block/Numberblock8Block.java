...
public class Numberblock8Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:numberblock_8")
	public static final Block block = null;

	public Numberblock8Block(OcmModElements instance) {
		super(instance, 920);
	}
