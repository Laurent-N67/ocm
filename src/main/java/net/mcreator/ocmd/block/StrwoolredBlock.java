...
public class StrwoolredBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:strwoolred")
	public static final Block block = null;

	public StrwoolredBlock(OcmModElements instance) {
		super(instance, 395);
	}
