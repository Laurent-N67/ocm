...
public class PlatinemetalbrickstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:platinemetalbrickstair")
	public static final Block block = null;

	public PlatinemetalbrickstairBlock(OcmModElements instance) {
		super(instance, 2126);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("platinemetalbrickstair");
		}
