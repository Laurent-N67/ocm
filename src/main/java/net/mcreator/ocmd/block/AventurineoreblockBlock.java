...
public class AventurineoreblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:aventurineoreblock")
	public static final Block block = null;

	public AventurineoreblockBlock(OcmModElements instance) {
		super(instance, 998);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aventurineoreblock");
		}
