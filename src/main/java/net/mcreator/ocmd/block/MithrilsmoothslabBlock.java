...
public class MithrilsmoothslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:mithrilsmoothslab")
	public static final Block block = null;

	public MithrilsmoothslabBlock(OcmModElements instance) {
		super(instance, 1103);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("mithrilsmoothslab");
		}
