...
public class BenchrightBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:benchright")
	public static final Block block = null;

	public BenchrightBlock(OcmModElements instance) {
		super(instance, 844);
	}
