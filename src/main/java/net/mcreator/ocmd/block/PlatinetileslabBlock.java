...
public class PlatinetileslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:platinetileslab")
	public static final Block block = null;

	public PlatinetileslabBlock(OcmModElements instance) {
		super(instance, 2130);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("platinetileslab");
		}
