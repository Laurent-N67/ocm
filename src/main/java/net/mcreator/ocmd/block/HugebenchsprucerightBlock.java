...
public class HugebenchsprucerightBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:hugebenchspruceright")
	public static final Block block = null;

	public HugebenchsprucerightBlock(OcmModElements instance) {
		super(instance, 853);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("hugebenchspruceright");
		}
