...
public class SaphirplankstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:saphirplankstair")
	public static final Block block = null;

	public SaphirplankstairBlock(OcmModElements instance) {
		super(instance, 2273);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("saphirplankstair");
		}
