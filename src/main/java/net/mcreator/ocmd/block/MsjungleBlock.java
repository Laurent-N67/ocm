...
public class MsjungleBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:msjungle")
	public static final Block block = null;

	public MsjungleBlock(OcmModElements instance) {
		super(instance, 592);
	}
