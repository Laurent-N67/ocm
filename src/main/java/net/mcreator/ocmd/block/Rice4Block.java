...
public class Rice4Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:rice_4")
	public static final Block block = null;

	public Rice4Block(OcmModElements instance) {
		super(instance, 1405);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("rice_4"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ocm:rice_4"), configuredFeature);
		}
	}
