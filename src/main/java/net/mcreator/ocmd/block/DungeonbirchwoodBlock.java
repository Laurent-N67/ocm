...
public class DungeonbirchwoodBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonbirchwood")
	public static final Block block = null;

	public DungeonbirchwoodBlock(OcmModElements instance) {
		super(instance, 1351);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("dungeonbirchwood");
		}
