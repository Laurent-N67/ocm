...
public class PortalredBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:portalred")
	public static final Block block = null;

	public PortalredBlock(OcmModElements instance) {
		super(instance, 642);
	}
