...
import net.mcreator.ocmd.procedures.Hersu5nsRedstoneOnProcedure;
import net.mcreator.ocmd.procedures.Hersu5nsRedstoneOffProcedure;
...
public class Hersu5nsBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:hersu_5ns")
	public static final Block block = null;

	public Hersu5nsBlock(OcmModElements instance) {
		super(instance, 656);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				...
				Hersu5nsRedstoneOnProcedure.executeProcedure(Stream
						.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x),
								new AbstractMap.SimpleEntry<>("y", y), new AbstractMap.SimpleEntry<>("z", z))
						.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
			} else {

				Hersu5nsRedstoneOffProcedure.executeProcedure(Stream
						.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x),
								new AbstractMap.SimpleEntry<>("y", y), new AbstractMap.SimpleEntry<>("z", z))
						.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
			}
