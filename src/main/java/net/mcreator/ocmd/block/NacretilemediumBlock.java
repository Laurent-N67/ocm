...
public class NacretilemediumBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:nacretilemedium")
	public static final Block block = null;

	public NacretilemediumBlock(OcmModElements instance) {
		super(instance, 1113);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("nacretilemedium");
		}
