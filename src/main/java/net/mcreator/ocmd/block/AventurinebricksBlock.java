...
public class AventurinebricksBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:aventurinebricks")
	public static final Block block = null;

	public AventurinebricksBlock(OcmModElements instance) {
		super(instance, 997);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aventurinebricks");
		}
