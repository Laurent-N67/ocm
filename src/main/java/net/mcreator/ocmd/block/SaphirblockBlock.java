...
public class SaphirblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:saphirblock")
	public static final Block block = null;

	public SaphirblockBlock(OcmModElements instance) {
		super(instance, 2143);
	}
