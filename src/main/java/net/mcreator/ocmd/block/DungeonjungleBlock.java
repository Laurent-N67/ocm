...
public class DungeonjungleBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonjungle")
	public static final Block block = null;

	public DungeonjungleBlock(OcmModElements instance) {
		super(instance, 1323);
	}
