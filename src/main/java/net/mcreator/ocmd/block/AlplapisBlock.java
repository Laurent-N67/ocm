...
public class AlplapisBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:alplapis")
	public static final Block block = null;

	public AlplapisBlock(OcmModElements instance) {
		super(instance, 486);
	}
