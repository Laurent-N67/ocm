...
public class BlackstbBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:blackstb")
	public static final Block block = null;

	public BlackstbBlock(OcmModElements instance) {
		super(instance, 563);
	}
