...
import net.mcreator.ocmd.procedures.Sakestg2UpdateTickProcedure;
...
public class Sakestg2Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:sakestg_2")
	public static final Block block = null;

	public Sakestg2Block(OcmModElements instance) {
		super(instance, 601);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			Sakestg2UpdateTickProcedure.executeProcedure(Stream
