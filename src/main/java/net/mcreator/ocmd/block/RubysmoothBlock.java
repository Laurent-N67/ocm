...
public class RubysmoothBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:rubysmooth")
	public static final Block block = null;

	public RubysmoothBlock(OcmModElements instance) {
		super(instance, 2134);
	}
