...
public class EmeraldlogBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:emeraldlog")
	public static final Block block = null;

	public EmeraldlogBlock(OcmModElements instance) {
		super(instance, 2225);
	}
