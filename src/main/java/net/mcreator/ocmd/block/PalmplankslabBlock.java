...
public class PalmplankslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:palmplankslab")
	public static final Block block = null;

	public PalmplankslabBlock(OcmModElements instance) {
		super(instance, 2266);
	}
