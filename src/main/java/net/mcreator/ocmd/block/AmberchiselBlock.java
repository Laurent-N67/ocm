...
public class AmberchiselBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:amberchisel")
	public static final Block block = null;

	public AmberchiselBlock(OcmModElements instance) {
		super(instance, 989);
	}
