...
public class GoldmetalbricksslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:goldmetalbricksslab")
	public static final Block block = null;

	public GoldmetalbricksslabBlock(OcmModElements instance) {
		super(instance, 1038);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("goldmetalbricksslab");
		}
