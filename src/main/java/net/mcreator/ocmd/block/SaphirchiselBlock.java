...
public class SaphirchiselBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:saphirchisel")
	public static final Block block = null;

	public SaphirchiselBlock(OcmModElements instance) {
		super(instance, 2146);
	}
