...
import net.mcreator.ocmd.procedures.Sakestg1UpdateTickProcedure;
...
public class Sakestg1Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:sakestg_1")
	public static final Block block = null;

	public Sakestg1Block(OcmModElements instance) {
		super(instance, 600);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			Sakestg1UpdateTickProcedure.executeProcedure(Stream
