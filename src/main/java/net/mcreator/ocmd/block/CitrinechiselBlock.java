...
public class CitrinechiselBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:citrinechisel")
	public static final Block block = null;

	public CitrinechiselBlock(OcmModElements instance) {
		super(instance, 1013);
	}
