...
public class NacretilesmallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:nacretilesmall")
	public static final Block block = null;

	public NacretilesmallBlock(OcmModElements instance) {
		super(instance, 1114);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("nacretilesmall");
		}
