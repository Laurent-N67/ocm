...
public class UpblocksupportsavanaBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:upblocksupportsavana")
	public static final Block block = null;

	public UpblocksupportsavanaBlock(OcmModElements instance) {
		super(instance, 773);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("upblocksupportsavana");
		}
