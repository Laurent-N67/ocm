...
public class DungeonoakwoodBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonoakwood")
	public static final Block block = null;

	public DungeonoakwoodBlock(OcmModElements instance) {
		super(instance, 1301);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("dungeonoakwood");
		}
