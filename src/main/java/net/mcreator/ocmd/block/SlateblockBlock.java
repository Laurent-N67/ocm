...
public class SlateblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:slateblock")
	public static final Block block = null;

	public SlateblockBlock(OcmModElements instance) {
		super(instance, 2154);
	}
