...
public class SpinelbrickstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:spinelbrickstair")
	public static final Block block = null;

	public SpinelbrickstairBlock(OcmModElements instance) {
		super(instance, 2172);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("spinelbrickstair");
		}
