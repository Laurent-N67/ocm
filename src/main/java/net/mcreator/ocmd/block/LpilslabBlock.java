...
public class LpilslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:lpilslab")
	public static final Block block = null;

	public LpilslabBlock(OcmModElements instance) {
		super(instance, 501);
	}
