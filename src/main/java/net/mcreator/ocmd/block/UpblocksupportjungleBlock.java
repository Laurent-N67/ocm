...
public class UpblocksupportjungleBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:upblocksupportjungle")
	public static final Block block = null;

	public UpblocksupportjungleBlock(OcmModElements instance) {
		super(instance, 772);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("upblocksupportjungle");
		}
