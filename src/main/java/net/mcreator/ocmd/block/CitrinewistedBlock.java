...
public class CitrinewistedBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:citrinewisted")
	public static final Block block = null;

	public CitrinewistedBlock(OcmModElements instance) {
		super(instance, 1017);
	}
