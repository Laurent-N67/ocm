...
public class TopazbrickslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:topazbrickslab")
	public static final Block block = null;

	public TopazbrickslabBlock(OcmModElements instance) {
		super(instance, 2196);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("topazbrickslab");
		}
