...
import net.mcreator.ocmd.procedures.AcidMobplayerCollidesBlockProcedure;
...
public class AcidBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:acid")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("ocm:acid_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;

	public AcidBlock(OcmModElements instance) {
		super(instance, 12);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("ocm:blocks/acidliquid"), new ResourceLocation("ocm:blocks/acidliquid")).luminosity(0)
