...
public class SaphirweaverBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:saphirweaver")
	public static final Block block = null;

	public SaphirweaverBlock(OcmModElements instance) {
		super(instance, 2149);
	}
