...
public class DungeonpillarBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonpillar")
	public static final Block block = null;

	public DungeonpillarBlock(OcmModElements instance) {
		super(instance, 903);
	}
