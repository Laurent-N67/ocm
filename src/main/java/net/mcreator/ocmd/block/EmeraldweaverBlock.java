...
public class EmeraldweaverBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:emeraldweaver")
	public static final Block block = null;

	public EmeraldweaverBlock(OcmModElements instance) {
		super(instance, 1028);
	}
