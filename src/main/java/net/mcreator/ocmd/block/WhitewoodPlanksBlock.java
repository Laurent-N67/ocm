...
public class WhitewoodPlanksBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:whitewood_planks")
	public static final Block block = null;

	public WhitewoodPlanksBlock(OcmModElements instance) {
		super(instance, 823);
	}
