...
public class CitrinetilemediumBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:citrinetilemedium")
	public static final Block block = null;

	public CitrinetilemediumBlock(OcmModElements instance) {
		super(instance, 1014);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("citrinetilemedium");
		}
