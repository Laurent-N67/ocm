...
public class IronmetalbrickslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ironmetalbrickslab")
	public static final Block block = null;

	public IronmetalbrickslabBlock(OcmModElements instance) {
		super(instance, 1063);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("ironmetalbrickslab");
		}
