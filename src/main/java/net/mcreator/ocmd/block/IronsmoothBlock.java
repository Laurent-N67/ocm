...
public class IronsmoothBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ironsmooth")
	public static final Block block = null;

	public IronsmoothBlock(OcmModElements instance) {
		super(instance, 1064);
	}
