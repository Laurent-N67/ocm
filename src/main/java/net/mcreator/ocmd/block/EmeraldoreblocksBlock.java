...
public class EmeraldoreblocksBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:emeraldoreblocks")
	public static final Block block = null;

	public EmeraldoreblocksBlock(OcmModElements instance) {
		super(instance, 1022);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("emeraldoreblocks");
		}
