...
public class Chistn3Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:chistn_3")
	public static final Block block = null;

	public Chistn3Block(OcmModElements instance) {
		super(instance, 556);
	}
