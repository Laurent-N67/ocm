...
public class Chisbk2Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:chisbk_2")
	public static final Block block = null;

	public Chisbk2Block(OcmModElements instance) {
		super(instance, 614);
	}
