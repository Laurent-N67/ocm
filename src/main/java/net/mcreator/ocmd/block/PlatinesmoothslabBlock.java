...
public class PlatinesmoothslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:platinesmoothslab")
	public static final Block block = null;

	public PlatinesmoothslabBlock(OcmModElements instance) {
		super(instance, 2210);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("platinesmoothslab");
		}
