...
public class DeaddirtBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:deaddirt")
	public static final Block block = null;

	public DeaddirtBlock(OcmModElements instance) {
		super(instance, 2567);
	}
