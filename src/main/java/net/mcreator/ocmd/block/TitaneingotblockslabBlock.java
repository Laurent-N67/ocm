...
public class TitaneingotblockslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:titaneingotblockslab")
	public static final Block block = null;

	public TitaneingotblockslabBlock(OcmModElements instance) {
		super(instance, 2176);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("titaneingotblockslab");
		}
