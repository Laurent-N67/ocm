...
public class GoldtileBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:goldtile")
	public static final Block block = null;

	public GoldtileBlock(OcmModElements instance) {
		super(instance, 1042);
	}
