...
public class MarblechiselBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:marblechisel")
	public static final Block block = null;

	public MarblechiselBlock(OcmModElements instance) {
		super(instance, 1088);
	}
