...
public class DungeonstoneBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonstone")
	public static final Block block = null;

	public DungeonstoneBlock(OcmModElements instance) {
		super(instance, 1296);
	}
