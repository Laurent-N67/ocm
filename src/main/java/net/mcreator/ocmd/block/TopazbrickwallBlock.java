...
public class TopazbrickwallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:topazbrickwall")
	public static final Block block = null;

	public TopazbrickwallBlock(OcmModElements instance) {
		super(instance, 2217);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("topazbrickwall");
		}
