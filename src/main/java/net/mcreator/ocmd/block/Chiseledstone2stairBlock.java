...
public class Chiseledstone2stairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:chiseledstone_2stair")
	public static final Block block = null;

	public Chiseledstone2stairBlock(OcmModElements instance) {
		super(instance, 723);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseledstone_2stair");
		}
