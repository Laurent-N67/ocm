...
public class MithrilsmoothBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:mithrilsmooth")
	public static final Block block = null;

	public MithrilsmoothBlock(OcmModElements instance) {
		super(instance, 1101);
	}
