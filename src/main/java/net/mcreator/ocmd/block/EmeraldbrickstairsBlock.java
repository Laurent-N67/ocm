...
public class EmeraldbrickstairsBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:emeraldbrickstairs")
	public static final Block block = null;

	public EmeraldbrickstairsBlock(OcmModElements instance) {
		super(instance, 1030);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("emeraldbrickstairs");
		}
