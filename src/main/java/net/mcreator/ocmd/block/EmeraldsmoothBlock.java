...
public class EmeraldsmoothBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:emeraldsmooth")
	public static final Block block = null;

	public EmeraldsmoothBlock(OcmModElements instance) {
		super(instance, 1024);
	}
