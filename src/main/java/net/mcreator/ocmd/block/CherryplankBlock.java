...
public class CherryplankBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:cherryplank")
	public static final Block block = null;

	public CherryplankBlock(OcmModElements instance) {
		super(instance, 2236);
	}
