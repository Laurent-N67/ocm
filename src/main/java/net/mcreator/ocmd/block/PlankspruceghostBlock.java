...
public class PlankspruceghostBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:plankspruceghost")
	public static final Block block = null;

	public PlankspruceghostBlock(OcmModElements instance) {
		super(instance, 960);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("plankspruceghost");
		}
