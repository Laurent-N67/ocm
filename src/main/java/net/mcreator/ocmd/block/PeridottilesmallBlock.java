...
public class PeridottilesmallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:peridottilesmall")
	public static final Block block = null;

	public PeridottilesmallBlock(OcmModElements instance) {
		super(instance, 1125);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("peridottilesmall");
		}
