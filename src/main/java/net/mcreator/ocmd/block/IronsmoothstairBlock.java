...
public class IronsmoothstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ironsmoothstair")
	public static final Block block = null;

	public IronsmoothstairBlock(OcmModElements instance) {
		super(instance, 1065);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("ironsmoothstair");
		}
