...
public class DungeonspruceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonspruce")
	public static final Block block = null;

	public DungeonspruceBlock(OcmModElements instance) {
		super(instance, 1320);
	}
