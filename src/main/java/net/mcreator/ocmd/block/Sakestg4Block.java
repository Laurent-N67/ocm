...
import net.mcreator.ocmd.procedures.Sakestg4UpdateTickProcedure;
...
public class Sakestg4Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:sakestg_4")
	public static final Block block = null;

	public Sakestg4Block(OcmModElements instance) {
		super(instance, 603);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			Sakestg4UpdateTickProcedure.executeProcedure(Stream
