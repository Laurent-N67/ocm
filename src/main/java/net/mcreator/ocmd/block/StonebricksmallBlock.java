...
public class StonebricksmallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:stonebricksmall")
	public static final Block block = null;

	public StonebricksmallBlock(OcmModElements instance) {
		super(instance, 983);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stonebricksmall");
		}
