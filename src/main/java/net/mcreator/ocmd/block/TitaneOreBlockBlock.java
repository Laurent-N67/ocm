...
public class TitaneOreBlockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:titane_ore_block")
	public static final Block block = null;

	public TitaneOreBlockBlock(OcmModElements instance) {
		super(instance, 422);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("titane_ore_block");
		}
