...
public class StrwoolprpBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:strwoolprp")
	public static final Block block = null;

	public StrwoolprpBlock(OcmModElements instance) {
		super(instance, 413);
	}
