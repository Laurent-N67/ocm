...
public class StrwoolyelBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:strwoolyel")
	public static final Block block = null;

	public StrwoolyelBlock(OcmModElements instance) {
		super(instance, 399);
	}
