...
import net.mcreator.ocmd.procedures.ConvoyerbeltQuandLentiteEntreEnCollisionAvecLeBlocProcedure;
...
public class ConvoyerbeltBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:convoyerbelt")
	public static final Block block = null;

	public ConvoyerbeltBlock(OcmModElements instance) {
		super(instance, 892);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
			...
			ConvoyerbeltQuandLentiteEntreEnCollisionAvecLeBlocProcedure.executeProcedure(Stream
