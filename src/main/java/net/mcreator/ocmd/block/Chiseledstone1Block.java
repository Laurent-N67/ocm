...
public class Chiseledstone1Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:chiseledstone_1")
	public static final Block block = null;

	public Chiseledstone1Block(OcmModElements instance) {
		super(instance, 718);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chiseledstone_1");
		}
