...
public class PeridotbrickstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:peridotbrickstair")
	public static final Block block = null;

	public PeridotbrickstairBlock(OcmModElements instance) {
		super(instance, 1128);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("peridotbrickstair");
		}
