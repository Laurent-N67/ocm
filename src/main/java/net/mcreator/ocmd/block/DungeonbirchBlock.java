...
public class DungeonbirchBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonbirch")
	public static final Block block = null;

	public DungeonbirchBlock(OcmModElements instance) {
		super(instance, 1315);
	}
