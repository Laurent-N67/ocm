...
public class RubyplankfenceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:rubyplankfence")
	public static final Block block = null;

	public RubyplankfenceBlock(OcmModElements instance) {
		super(instance, 2271);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("rubyplankfence");
		}
