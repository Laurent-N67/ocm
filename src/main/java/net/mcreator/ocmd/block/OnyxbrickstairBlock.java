...
public class OnyxbrickstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:onyxbrickstair")
	public static final Block block = null;

	public OnyxbrickstairBlock(OcmModElements instance) {
		super(instance, 2206);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("onyxbrickstair");
		}
