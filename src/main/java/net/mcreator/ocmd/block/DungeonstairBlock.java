...
public class DungeonstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonstair")
	public static final Block block = null;

	public DungeonstairBlock(OcmModElements instance) {
		super(instance, 898);
	}
