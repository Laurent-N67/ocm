...
public class DalleupsavanaBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dalleupsavana")
	public static final Block block = null;

	public DalleupsavanaBlock(OcmModElements instance) {
		super(instance, 748);
	}
