...
public class Chistn2Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:chistn_2")
	public static final Block block = null;

	public Chistn2Block(OcmModElements instance) {
		super(instance, 555);
	}
