...
public class SquarestoneBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:squarestone")
	public static final Block block = null;

	public SquarestoneBlock(OcmModElements instance) {
		super(instance, 554);
	}
