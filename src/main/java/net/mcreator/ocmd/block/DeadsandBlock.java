...
public class DeadsandBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:deadsand")
	public static final Block block = null;

	public DeadsandBlock(OcmModElements instance) {
		super(instance, 2568);
	}
