...
public class Dungeonstone2Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonstone_2")
	public static final Block block = null;

	public Dungeonstone2Block(OcmModElements instance) {
		super(instance, 1297);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dungeonstone_2");
		}
