...
public class Plantoa5Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:plantoa_5")
	public static final Block block = null;

	public Plantoa5Block(OcmModElements instance) {
		super(instance, 1142);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("plantoa_5"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ocm:plantoa_5"), configuredFeature);
		}
	}
