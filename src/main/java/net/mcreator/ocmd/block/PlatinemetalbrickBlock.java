...
public class PlatinemetalbrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:platinemetalbrick")
	public static final Block block = null;

	public PlatinemetalbrickBlock(OcmModElements instance) {
		super(instance, 2125);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("platinemetalbrick");
		}
