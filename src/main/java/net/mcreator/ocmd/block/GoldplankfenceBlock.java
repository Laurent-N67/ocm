...
public class GoldplankfenceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:goldplankfence")
	public static final Block block = null;

	public GoldplankfenceBlock(OcmModElements instance) {
		super(instance, 2263);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("goldplankfence");
		}
