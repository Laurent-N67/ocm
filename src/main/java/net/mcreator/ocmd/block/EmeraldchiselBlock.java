...
public class EmeraldchiselBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:emeraldchisel")
	public static final Block block = null;

	public EmeraldchiselBlock(OcmModElements instance) {
		super(instance, 1025);
	}
