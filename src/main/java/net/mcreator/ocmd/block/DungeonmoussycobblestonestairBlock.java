...
public class DungeonmoussycobblestonestairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonmoussycobblestonestair")
	public static final Block block = null;

	public DungeonmoussycobblestonestairBlock(OcmModElements instance) {
		super(instance, 1347);
	}
		...
		public CustomBlock() {
			super(() -> new Block(
					Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 0))
							.getDefaultState(),
					Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 0));
			setRegistryName("dungeonmoussycobblestonestair");
		}
