...
public class AmbertilemediumBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ambertilemedium")
	public static final Block block = null;

	public AmbertilemediumBlock(OcmModElements instance) {
		super(instance, 990);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ambertilemedium");
		}
