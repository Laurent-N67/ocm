...
public class MithrilingotblockstairsBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:mithrilingotblockstairs")
	public static final Block block = null;

	public MithrilingotblockstairsBlock(OcmModElements instance) {
		super(instance, 1096);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("mithrilingotblockstairs");
		}
