...
public class Chistn4Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:chistn_4")
	public static final Block block = null;

	public Chistn4Block(OcmModElements instance) {
		super(instance, 557);
	}
