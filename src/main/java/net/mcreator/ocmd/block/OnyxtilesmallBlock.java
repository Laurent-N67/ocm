...
public class OnyxtilesmallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:onyxtilesmall")
	public static final Block block = null;

	public OnyxtilesmallBlock(OcmModElements instance) {
		super(instance, 2203);
	}
