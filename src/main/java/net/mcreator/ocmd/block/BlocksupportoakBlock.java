...
public class BlocksupportoakBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:blocksupportoak")
	public static final Block block = null;

	public BlocksupportoakBlock(OcmModElements instance) {
		super(instance, 763);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("blocksupportoak");
		}
