...
public class TopazbrickstairsBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:topazbrickstairs")
	public static final Block block = null;

	public TopazbrickstairsBlock(OcmModElements instance) {
		super(instance, 2195);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("topazbrickstairs");
		}
