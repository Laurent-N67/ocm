...
import net.mcreator.ocmd.procedures.SlotmachinecLorsDunClicDroitSurLeBlocProcedure;
...
public class SlotmachinecBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:slotmachinec")
	public static final Block block = null;

	public SlotmachinecBlock(OcmModElements instance) {
		super(instance, 943);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			SlotmachinecLorsDunClicDroitSurLeBlocProcedure.executeProcedure(Stream
