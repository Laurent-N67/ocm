...
public class ParadiseportalblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:paradiseportalblock")
	public static final Block block = null;

	public ParadiseportalblockBlock(OcmModElements instance) {
		super(instance, 878);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("paradiseportalblock");
		}
