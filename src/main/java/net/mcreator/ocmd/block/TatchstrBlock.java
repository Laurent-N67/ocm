...
public class TatchstrBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:tatchstr")
	public static final Block block = null;

	public TatchstrBlock(OcmModElements instance) {
		super(instance, 633);
	}
