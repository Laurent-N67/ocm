...
public class GoldmetalbricksBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:goldmetalbricks")
	public static final Block block = null;

	public GoldmetalbricksBlock(OcmModElements instance) {
		super(instance, 1036);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("goldmetalbricks");
		}
