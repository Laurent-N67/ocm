...
public class TatchslbBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:tatchslb")
	public static final Block block = null;

	public TatchslbBlock(OcmModElements instance) {
		super(instance, 634);
	}
