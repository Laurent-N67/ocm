...
public class Dungeonglasspan1Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonglasspan_1")
	public static final Block block = null;

	public Dungeonglasspan1Block(OcmModElements instance) {
		super(instance, 1342);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			...
			setRegistryName("dungeonglasspan_1");
		}
