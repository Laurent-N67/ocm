...
public class SaphirbricksBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:saphirbricks")
	public static final Block block = null;

	public SaphirbricksBlock(OcmModElements instance) {
		super(instance, 2142);
	}
