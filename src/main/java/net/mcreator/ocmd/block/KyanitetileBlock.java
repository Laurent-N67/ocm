...
public class KyanitetileBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:kyanitetile")
	public static final Block block = null;

	public KyanitetileBlock(OcmModElements instance) {
		super(instance, 1076);
	}
