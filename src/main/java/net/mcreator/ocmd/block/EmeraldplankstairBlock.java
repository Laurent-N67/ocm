...
public class EmeraldplankstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:emeraldplankstair")
	public static final Block block = null;

	public EmeraldplankstairBlock(OcmModElements instance) {
		super(instance, 2249);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("emeraldplankstair");
		}
