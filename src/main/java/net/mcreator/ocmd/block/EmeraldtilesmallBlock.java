...
public class EmeraldtilesmallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:emeraldtilesmall")
	public static final Block block = null;

	public EmeraldtilesmallBlock(OcmModElements instance) {
		super(instance, 1027);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("emeraldtilesmall");
		}
