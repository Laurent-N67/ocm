...
public class Plantoa8Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:plantoa_8")
	public static final Block block = null;

	public Plantoa8Block(OcmModElements instance) {
		super(instance, 1145);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("plantoa_8"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ocm:plantoa_8"), configuredFeature);
		}
	}
