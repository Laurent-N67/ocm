...
public class PeridotweaverBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:peridotweaver")
	public static final Block block = null;

	public PeridotweaverBlock(OcmModElements instance) {
		super(instance, 1126);
	}
