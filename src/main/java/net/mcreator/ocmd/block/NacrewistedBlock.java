...
public class NacrewistedBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:nacrewisted")
	public static final Block block = null;

	public NacrewistedBlock(OcmModElements instance) {
		super(instance, 1116);
	}
