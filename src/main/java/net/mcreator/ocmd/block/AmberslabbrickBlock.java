...
public class AmberslabbrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:amberslabbrick")
	public static final Block block = null;

	public AmberslabbrickBlock(OcmModElements instance) {
		super(instance, 995);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("amberslabbrick");
		}
