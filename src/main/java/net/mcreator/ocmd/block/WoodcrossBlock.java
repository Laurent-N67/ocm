...
public class WoodcrossBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:woodcross")
	public static final Block block = null;

	public WoodcrossBlock(OcmModElements instance) {
		super(instance, 571);
	}
