...
public class EmeraldwistedBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:emeraldwisted")
	public static final Block block = null;

	public EmeraldwistedBlock(OcmModElements instance) {
		super(instance, 1029);
	}
