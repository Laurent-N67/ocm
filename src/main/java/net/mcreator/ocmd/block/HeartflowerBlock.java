...
public class HeartflowerBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:heartflower")
	public static final Block block = null;

	public HeartflowerBlock(OcmModElements instance) {
		super(instance, 1137);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("heartflower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ocm:heartflower"), configuredFeature);
		}
	}
