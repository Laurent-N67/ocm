...
public class RitualtotemBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ritualtotem")
	public static final Block block = null;

	public RitualtotemBlock(OcmModElements instance) {
		super(instance, 783);
	}
