...
public class JapanportalblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:japanportalblock")
	public static final Block block = null;

	public JapanportalblockBlock(OcmModElements instance) {
		super(instance, 889);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("japanportalblock");
		}
