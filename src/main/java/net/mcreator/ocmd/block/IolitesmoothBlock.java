...
public class IolitesmoothBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:iolitesmooth")
	public static final Block block = null;

	public IolitesmoothBlock(OcmModElements instance) {
		super(instance, 1049);
	}
