...
public class SingletablespruceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:singletablespruce")
	public static final Block block = null;

	public SingletablespruceBlock(OcmModElements instance) {
		super(instance, 738);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("singletablespruce");
		}
