...
public class DarkprismslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:darkprismslab")
	public static final Block block = null;

	public DarkprismslabBlock(OcmModElements instance) {
		super(instance, 709);
	}
