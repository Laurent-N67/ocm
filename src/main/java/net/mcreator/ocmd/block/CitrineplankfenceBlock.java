...
public class CitrineplankfenceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:citrineplankfence")
	public static final Block block = null;

	public CitrineplankfenceBlock(OcmModElements instance) {
		super(instance, 2243);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("citrineplankfence");
		}
