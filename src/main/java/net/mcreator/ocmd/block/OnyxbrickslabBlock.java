...
public class OnyxbrickslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:onyxbrickslab")
	public static final Block block = null;

	public OnyxbrickslabBlock(OcmModElements instance) {
		super(instance, 2207);
	}
