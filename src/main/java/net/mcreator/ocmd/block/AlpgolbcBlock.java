...
public class AlpgolbcBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:alpgolbc")
	public static final Block block = null;

	public AlpgolbcBlock(OcmModElements instance) {
		super(instance, 487);
	}
