...
public class Chistn5Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:chistn_5")
	public static final Block block = null;

	public Chistn5Block(OcmModElements instance) {
		super(instance, 560);
	}
