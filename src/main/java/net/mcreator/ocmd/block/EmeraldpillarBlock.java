...
public class EmeraldpillarBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:emeraldpillar")
	public static final Block block = null;

	public EmeraldpillarBlock(OcmModElements instance) {
		super(instance, 1023);
	}
