...
public class DalleupdarkoakBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dalleupdarkoak")
	public static final Block block = null;

	public DalleupdarkoakBlock(OcmModElements instance) {
		super(instance, 747);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("dalleupdarkoak");
		}
