...
public class RedbrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:redbrick")
	public static final Block block = null;

	public RedbrickBlock(OcmModElements instance) {
		super(instance, 459);
	}
