...
public class TatchblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:tatchblock")
	public static final Block block = null;

	public TatchblockBlock(OcmModElements instance) {
		super(instance, 474);
	}
