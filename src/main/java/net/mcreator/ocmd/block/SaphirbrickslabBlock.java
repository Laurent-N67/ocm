...
public class SaphirbrickslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:saphirbrickslab")
	public static final Block block = null;

	public SaphirbrickslabBlock(OcmModElements instance) {
		super(instance, 2152);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("saphirbrickslab");
		}
