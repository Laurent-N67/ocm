...
public class MarblesblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:marblesblock")
	public static final Block block = null;

	public MarblesblockBlock(OcmModElements instance) {
		super(instance, 1085);
	}
