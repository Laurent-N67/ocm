...
public class SingletablebirchBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:singletablebirch")
	public static final Block block = null;

	public SingletablebirchBlock(OcmModElements instance) {
		super(instance, 739);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("singletablebirch");
		}
