...
public class HugecbenchoakrightBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:hugecbenchoakright")
	public static final Block block = null;

	public HugecbenchoakrightBlock(OcmModElements instance) {
		super(instance, 847);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("hugecbenchoakright");
		}
