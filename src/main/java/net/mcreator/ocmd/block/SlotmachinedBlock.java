...
import net.mcreator.ocmd.procedures.SlotmachinedLorsDunClicDroitSurLeBlocProcedure;
...
public class SlotmachinedBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:slotmachined")
	public static final Block block = null;

	public SlotmachinedBlock(OcmModElements instance) {
		super(instance, 944);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			SlotmachinedLorsDunClicDroitSurLeBlocProcedure.executeProcedure(Stream
