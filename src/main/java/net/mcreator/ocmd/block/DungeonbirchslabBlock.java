...
public class DungeonbirchslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonbirchslab")
	public static final Block block = null;

	public DungeonbirchslabBlock(OcmModElements instance) {
		super(instance, 1317);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dungeonbirchslab");
		}
