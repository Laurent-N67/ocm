...
public class PlatformoakBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:platformoak")
	public static final Block block = null;

	public PlatformoakBlock(OcmModElements instance) {
		super(instance, 775);
	}
