...
public class JaplanternstringBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:japlanternstring")
	public static final Block block = null;

	public JaplanternstringBlock(OcmModElements instance) {
		super(instance, 836);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("japlanternstring");
		}
