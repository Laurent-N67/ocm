...
public class AlpgrassBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:alpgrass")
	public static final Block block = null;

	public AlpgrassBlock(OcmModElements instance) {
		super(instance, 483);
	}
