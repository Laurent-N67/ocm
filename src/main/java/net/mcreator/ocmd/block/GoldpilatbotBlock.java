...
public class GoldpilatbotBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:goldpilatbot")
	public static final Block block = null;

	public GoldpilatbotBlock(OcmModElements instance) {
		super(instance, 875);
	}
