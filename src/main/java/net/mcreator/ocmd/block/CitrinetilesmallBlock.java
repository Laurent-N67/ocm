...
public class CitrinetilesmallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:citrinetilesmall")
	public static final Block block = null;

	public CitrinetilesmallBlock(OcmModElements instance) {
		super(instance, 1015);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("citrinetilesmall");
		}
