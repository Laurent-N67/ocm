...
public class RubytilemediumBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:rubytilemedium")
	public static final Block block = null;

	public RubytilemediumBlock(OcmModElements instance) {
		super(instance, 2136);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rubytilemedium");
		}
