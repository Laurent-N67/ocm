...
public class DungeonwhitestonebrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonwhitestonebrick")
	public static final Block block = null;

	public DungeonwhitestonebrickBlock(OcmModElements instance) {
		super(instance, 1313);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dungeonwhitestonebrick");
		}
