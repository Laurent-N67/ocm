...
public class BlocksupportsavanaBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:blocksupportsavana")
	public static final Block block = null;

	public BlocksupportsavanaBlock(OcmModElements instance) {
		super(instance, 766);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("blocksupportsavana");
		}
