...
import net.mcreator.ocmd.procedures.TestcasinoLorsDunClicDroitSurLeBlocProcedure;
...
public class SlotmachineaBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:slotmachinea")
	public static final Block block = null;

	public SlotmachineaBlock(OcmModElements instance) {
		super(instance, 941);
	}
	...
	public static class CustomBlock extends Block {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			TestcasinoLorsDunClicDroitSurLeBlocProcedure.executeProcedure(Stream
