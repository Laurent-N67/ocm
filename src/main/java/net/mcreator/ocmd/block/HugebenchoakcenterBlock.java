...
public class HugebenchoakcenterBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:hugebenchoakcenter")
	public static final Block block = null;

	public HugebenchoakcenterBlock(OcmModElements instance) {
		super(instance, 846);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("hugebenchoakcenter");
		}
