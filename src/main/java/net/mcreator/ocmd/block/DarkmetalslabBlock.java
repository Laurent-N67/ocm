...
public class DarkmetalslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:darkmetalslab")
	public static final Block block = null;

	public DarkmetalslabBlock(OcmModElements instance) {
		super(instance, 717);
	}
