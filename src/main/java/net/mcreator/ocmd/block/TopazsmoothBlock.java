...
public class TopazsmoothBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:topazsmooth")
	public static final Block block = null;

	public TopazsmoothBlock(OcmModElements instance) {
		super(instance, 2189);
	}
