...
public class KyaniteoreblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:kyaniteoreblock")
	public static final Block block = null;

	public KyaniteoreblockBlock(OcmModElements instance) {
		super(instance, 1072);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("kyaniteoreblock");
		}
