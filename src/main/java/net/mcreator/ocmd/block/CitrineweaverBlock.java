...
public class CitrineweaverBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:citrineweaver")
	public static final Block block = null;

	public CitrineweaverBlock(OcmModElements instance) {
		super(instance, 1016);
	}
