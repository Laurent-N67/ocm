...
public class AmberstairbrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:amberstairbrick")
	public static final Block block = null;

	public AmberstairbrickBlock(OcmModElements instance) {
		super(instance, 994);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("amberstairbrick");
		}
