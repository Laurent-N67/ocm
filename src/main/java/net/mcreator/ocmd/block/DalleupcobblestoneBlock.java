...
public class DalleupcobblestoneBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dalleupcobblestone")
	public static final Block block = null;

	public DalleupcobblestoneBlock(OcmModElements instance) {
		super(instance, 752);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("dalleupcobblestone");
		}
