...
public class SpinelpillarBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:spinelpillar")
	public static final Block block = null;

	public SpinelpillarBlock(OcmModElements instance) {
		super(instance, 2165);
	}
