...
public class Chisst2Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:chisst_2")
	public static final Block block = null;

	public Chisst2Block(OcmModElements instance) {
		super(instance, 577);
	}
