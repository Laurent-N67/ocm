...
public class KyanitebrickstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:kyanitebrickstair")
	public static final Block block = null;

	public KyanitebrickstairBlock(OcmModElements instance) {
		super(instance, 1080);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("kyanitebrickstair");
		}
