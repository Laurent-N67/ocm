...
public class LeaveswallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:leaveswall")
	public static final Block block = null;

	public LeaveswallBlock(OcmModElements instance) {
		super(instance, 386);
	}
