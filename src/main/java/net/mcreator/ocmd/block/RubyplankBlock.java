...
public class RubyplankBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:rubyplank")
	public static final Block block = null;

	public RubyplankBlock(OcmModElements instance) {
		super(instance, 2268);
	}
