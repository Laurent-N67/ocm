...
public class IceleavesBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:iceleaves")
	public static final Block block = null;

	public IceleavesBlock(OcmModElements instance) {
		super(instance, 569);
	}
