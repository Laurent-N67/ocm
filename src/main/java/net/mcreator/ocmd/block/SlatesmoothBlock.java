...
public class SlatesmoothBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:slatesmooth")
	public static final Block block = null;

	public SlatesmoothBlock(OcmModElements instance) {
		super(instance, 2156);
	}
