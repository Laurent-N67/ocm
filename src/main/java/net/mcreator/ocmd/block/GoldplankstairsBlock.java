...
public class GoldplankstairsBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:goldplankstairs")
	public static final Block block = null;

	public GoldplankstairsBlock(OcmModElements instance) {
		super(instance, 2261);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("goldplankstairs");
		}
