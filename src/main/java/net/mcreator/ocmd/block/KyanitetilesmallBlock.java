...
public class KyanitetilesmallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:kyanitetilesmall")
	public static final Block block = null;

	public KyanitetilesmallBlock(OcmModElements instance) {
		super(instance, 1077);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("kyanitetilesmall");
		}
