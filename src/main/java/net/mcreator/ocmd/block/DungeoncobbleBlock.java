...
public class DungeoncobbleBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeoncobble")
	public static final Block block = null;

	public DungeoncobbleBlock(OcmModElements instance) {
		super(instance, 1302);
	}
