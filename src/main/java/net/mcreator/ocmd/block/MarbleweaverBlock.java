...
public class MarbleweaverBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:marbleweaver")
	public static final Block block = null;

	public MarbleweaverBlock(OcmModElements instance) {
		super(instance, 1091);
	}
