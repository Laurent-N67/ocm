...
public class LargesprucestoolBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:largesprucestool")
	public static final Block block = null;

	public LargesprucestoolBlock(OcmModElements instance) {
		super(instance, 862);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("largesprucestool");
		}
