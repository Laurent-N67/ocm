...
public class SaphirplankBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:saphirplank")
	public static final Block block = null;

	public SaphirplankBlock(OcmModElements instance) {
		super(instance, 2272);
	}
