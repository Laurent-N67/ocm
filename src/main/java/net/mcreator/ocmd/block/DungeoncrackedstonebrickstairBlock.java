...
public class DungeoncrackedstonebrickstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeoncrackedstonebrickstair")
	public static final Block block = null;

	public DungeoncrackedstonebrickstairBlock(OcmModElements instance) {
		super(instance, 1334);
	}
		...
		public CustomBlock() {
			super(() -> new Block(
					Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 0))
							.getDefaultState(),
					Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 0));
			setRegistryName("dungeoncrackedstonebrickstair");
		}
