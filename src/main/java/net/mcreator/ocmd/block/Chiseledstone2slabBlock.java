...
public class Chiseledstone2slabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:chiseledstone_2slab")
	public static final Block block = null;

	public Chiseledstone2slabBlock(OcmModElements instance) {
		super(instance, 722);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("chiseledstone_2slab");
		}
