...
public class IolitebrickslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:iolitebrickslab")
	public static final Block block = null;

	public IolitebrickslabBlock(OcmModElements instance) {
		super(instance, 1056);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("iolitebrickslab");
		}
