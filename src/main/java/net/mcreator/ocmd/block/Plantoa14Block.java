...
public class Plantoa14Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:plantoa_14")
	public static final Block block = null;

	public Plantoa14Block(OcmModElements instance) {
		super(instance, 1150);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("plantoa_14"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ocm:plantoa_14"), configuredFeature);
		}
	}
