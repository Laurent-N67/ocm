...
public class IrontileslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:irontileslab")
	public static final Block block = null;

	public IrontileslabBlock(OcmModElements instance) {
		super(instance, 1069);
	}
