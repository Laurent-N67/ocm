...
public class MarbletilesmallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:marbletilesmall")
	public static final Block block = null;

	public MarbletilesmallBlock(OcmModElements instance) {
		super(instance, 1090);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("marbletilesmall");
		}
