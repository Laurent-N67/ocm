...
public class MithrilsmoothstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:mithrilsmoothstair")
	public static final Block block = null;

	public MithrilsmoothstairBlock(OcmModElements instance) {
		super(instance, 1102);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("mithrilsmoothstair");
		}
