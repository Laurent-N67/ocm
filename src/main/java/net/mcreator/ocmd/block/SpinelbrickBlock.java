...
public class SpinelbrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:spinelbrick")
	public static final Block block = null;

	public SpinelbrickBlock(OcmModElements instance) {
		super(instance, 2163);
	}
