...
public class Cheseledstone1slabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:cheseledstone_1slab")
	public static final Block block = null;

	public Cheseledstone1slabBlock(OcmModElements instance) {
		super(instance, 719);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("cheseledstone_1slab");
		}
