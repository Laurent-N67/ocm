...
public class TronestoneblueBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:tronestoneblue")
	public static final Block block = null;

	public TronestoneblueBlock(OcmModElements instance) {
		super(instance, 865);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("tronestoneblue");
		}
