...
import net.mcreator.ocmd.procedures.Wnstg1UpdateTickProcedure;
...
public class Wnstg1Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:wnstg_1")
	public static final Block block = null;

	public Wnstg1Block(OcmModElements instance) {
		super(instance, 572);
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			Wnstg1UpdateTickProcedure.executeProcedure(Stream
