...
public class GridblocstBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:gridblocst")
	public static final Block block = null;

	public GridblocstBlock(OcmModElements instance) {
		super(instance, 445);
	}
