...
public class SlatetilesmallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:slatetilesmall")
	public static final Block block = null;

	public SlatetilesmallBlock(OcmModElements instance) {
		super(instance, 2158);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("slatetilesmall");
		}
