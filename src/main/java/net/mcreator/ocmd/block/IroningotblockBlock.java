...
public class IroningotblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ironingotblock")
	public static final Block block = null;

	public IroningotblockBlock(OcmModElements instance) {
		super(instance, 1058);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ironingotblock");
		}
