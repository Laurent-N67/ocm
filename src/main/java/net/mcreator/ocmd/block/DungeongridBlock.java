...
public class DungeongridBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeongrid")
	public static final Block block = null;

	public DungeongridBlock(OcmModElements instance) {
		super(instance, 1305);
	}
