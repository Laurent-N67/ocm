...
public class PlatineingotblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:platineingotblock")
	public static final Block block = null;

	public PlatineingotblockBlock(OcmModElements instance) {
		super(instance, 2122);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("platineingotblock");
		}
