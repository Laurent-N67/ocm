...
public class DungeonwavestoneBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonwavestone")
	public static final Block block = null;

	public DungeonwavestoneBlock(OcmModElements instance) {
		super(instance, 1345);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dungeonwavestone");
		}
