...
public class PilstslbBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:pilstslb")
	public static final Block block = null;

	public PilstslbBlock(OcmModElements instance) {
		super(instance, 495);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(4.800000000000001, 0, 4.800000000000001, 11.200000000000001, 16, 11.200000000000001)
