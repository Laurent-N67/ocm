...
public class DalleupbirchBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dalleupbirch")
	public static final Block block = null;

	public DalleupbirchBlock(OcmModElements instance) {
		super(instance, 743);
	}
