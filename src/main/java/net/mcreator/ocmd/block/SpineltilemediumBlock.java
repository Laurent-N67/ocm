...
public class SpineltilemediumBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:spineltilemedium")
	public static final Block block = null;

	public SpineltilemediumBlock(OcmModElements instance) {
		super(instance, 2168);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("spineltilemedium");
		}
