...
public class PeridotchiselBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:peridotchisel")
	public static final Block block = null;

	public PeridotchiselBlock(OcmModElements instance) {
		super(instance, 1123);
	}
