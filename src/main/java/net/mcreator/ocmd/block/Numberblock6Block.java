...
public class Numberblock6Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:numberblock_6")
	public static final Block block = null;

	public Numberblock6Block(OcmModElements instance) {
		super(instance, 918);
	}
