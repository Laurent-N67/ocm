...
public class NacrechiselBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:nacrechisel")
	public static final Block block = null;

	public NacrechiselBlock(OcmModElements instance) {
		super(instance, 1112);
	}
