...
public class Dungeonlanternblock2Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonlanternblock_2")
	public static final Block block = null;

	public Dungeonlanternblock2Block(OcmModElements instance) {
		super(instance, 1350);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dungeonlanternblock_2");
		}
