...
import net.mcreator.ocmd.item.CornItem;
...
public class Corn3Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:corn_3")
	public static final Block block = null;

	public Corn3Block(OcmModElements instance) {
		super(instance, 1161);
	}
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CornItem.block, (int) (3)));
		}
