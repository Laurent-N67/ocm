...
public class IronmetalbrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ironmetalbrick")
	public static final Block block = null;

	public IronmetalbrickBlock(OcmModElements instance) {
		super(instance, 1061);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ironmetalbrick");
		}
