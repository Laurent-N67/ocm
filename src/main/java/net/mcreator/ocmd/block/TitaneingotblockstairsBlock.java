...
public class TitaneingotblockstairsBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:titaneingotblockstairs")
	public static final Block block = null;

	public TitaneingotblockstairsBlock(OcmModElements instance) {
		super(instance, 2175);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("titaneingotblockstairs");
		}
