...
import net.mcreator.ocmd.procedures.OrangeleavesMiseAJourDuTickProcedure;
...
public class OrangeleavesBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:orangeleaves")
	public static final Block block = null;

	public OrangeleavesBlock(OcmModElements instance) {
		super(instance, 874);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			OrangeleavesMiseAJourDuTickProcedure.executeProcedure(Stream
