...
public class LargeoakstoolBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:largeoakstool")
	public static final Block block = null;

	public LargeoakstoolBlock(OcmModElements instance) {
		super(instance, 861);
	}
