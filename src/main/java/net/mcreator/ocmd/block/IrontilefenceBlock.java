...
public class IrontilefenceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:irontilefence")
	public static final Block block = null;

	public IrontilefenceBlock(OcmModElements instance) {
		super(instance, 1070);
	}
