...
public class CitrineblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:citrineblock")
	public static final Block block = null;

	public CitrineblockBlock(OcmModElements instance) {
		super(instance, 1010);
	}
