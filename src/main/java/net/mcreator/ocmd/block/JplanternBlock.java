...
public class JplanternBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:jplantern")
	public static final Block block = null;

	public JplanternBlock(OcmModElements instance) {
		super(instance, 465);
	}
