...
public class Chisbk4Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:chisbk_4")
	public static final Block block = null;

	public Chisbk4Block(OcmModElements instance) {
		super(instance, 617);
	}
