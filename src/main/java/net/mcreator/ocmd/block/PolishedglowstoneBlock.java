...
public class PolishedglowstoneBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:polishedglowstone")
	public static final Block block = null;

	public PolishedglowstoneBlock(OcmModElements instance) {
		super(instance, 957);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("polishedglowstone");
		}
