...
public class AmethystOreBlockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:amethyst_ore_block")
	public static final Block block = null;

	public AmethystOreBlockBlock(OcmModElements instance) {
		super(instance, 431);
	}
