...
public class HugebenchbirchcenterBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:hugebenchbirchcenter")
	public static final Block block = null;

	public HugebenchbirchcenterBlock(OcmModElements instance) {
		super(instance, 849);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("hugebenchbirchcenter");
		}
