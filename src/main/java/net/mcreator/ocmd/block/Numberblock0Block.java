...
public class Numberblock0Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:numberblock_0")
	public static final Block block = null;

	public Numberblock0Block(OcmModElements instance) {
		super(instance, 922);
	}
