...
import net.mcreator.ocmd.procedures.NodeonRedstoneEteinteProcedure;
import net.mcreator.ocmd.procedures.NodeonMiseAJourDuTickProcedure;
...
public class NodeonBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:nodeon")
	public static final Block block = null;

	public NodeonBlock(OcmModElements instance) {
		super(instance, 829);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(1f, 10f).setLightLevel(s -> 14).notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("nodeon");
		}
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				...
				NodeonRedstoneEteinteProcedure.executeProcedure(Stream
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			NodeonMiseAJourDuTickProcedure.executeProcedure(Stream
