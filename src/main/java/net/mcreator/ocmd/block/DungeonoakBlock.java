...
public class DungeonoakBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonoak")
	public static final Block block = null;

	public DungeonoakBlock(OcmModElements instance) {
		super(instance, 1298);
	}
