...
public class Flowerjar1Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:flowerjar_1")
	public static final Block block = null;

	public Flowerjar1Block(OcmModElements instance) {
		super(instance, 2516);
	}
