...
public class WalogoakBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:walogoak")
	public static final Block block = null;

	public WalogoakBlock(OcmModElements instance) {
		super(instance, 627);
	}
