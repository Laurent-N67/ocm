...
import net.mcreator.ocmd.procedures.Wnstg2UpdateTickProcedure;
...
public class Wnstg2Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:wnstg_2")
	public static final Block block = null;

	public Wnstg2Block(OcmModElements instance) {
		super(instance, 573);
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			Wnstg2UpdateTickProcedure.executeProcedure(Stream
