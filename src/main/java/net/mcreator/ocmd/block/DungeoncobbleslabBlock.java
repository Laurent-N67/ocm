...
public class DungeoncobbleslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeoncobbleslab")
	public static final Block block = null;

	public DungeoncobbleslabBlock(OcmModElements instance) {
		super(instance, 1303);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("dungeoncobbleslab");
		}
