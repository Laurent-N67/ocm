...
public class AlpcobbleBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:alpcobble")
	public static final Block block = null;

	public AlpcobbleBlock(OcmModElements instance) {
		super(instance, 484);
	}
