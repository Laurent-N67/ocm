...
public class IoliteoreblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ioliteoreblock")
	public static final Block block = null;

	public IoliteoreblockBlock(OcmModElements instance) {
		super(instance, 1047);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ioliteoreblock");
		}
