...
public class DungeoncobblestairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeoncobblestair")
	public static final Block block = null;

	public DungeoncobblestairBlock(OcmModElements instance) {
		super(instance, 1304);
	}
		...
		public CustomBlock() {
			super(() -> new Block(
					Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 0))
							.getDefaultState(),
					Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 0));
			setRegistryName("dungeoncobblestair");
		}
