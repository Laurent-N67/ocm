...
public class SpinelweaverBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:spinelweaver")
	public static final Block block = null;

	public SpinelweaverBlock(OcmModElements instance) {
		super(instance, 2170);
	}
