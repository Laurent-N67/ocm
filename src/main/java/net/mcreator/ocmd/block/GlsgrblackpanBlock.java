...
public class GlsgrblackpanBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:glsgrblackpan")
	public static final Block block = null;

	public GlsgrblackpanBlock(OcmModElements instance) {
		super(instance, 953);
	}
