...
public class KyanitechiselBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:kyanitechisel")
	public static final Block block = null;

	public KyanitechiselBlock(OcmModElements instance) {
		super(instance, 1075);
	}
