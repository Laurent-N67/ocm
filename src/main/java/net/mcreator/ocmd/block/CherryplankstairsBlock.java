...
public class CherryplankstairsBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:cherryplankstairs")
	public static final Block block = null;

	public CherryplankstairsBlock(OcmModElements instance) {
		super(instance, 2237);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("cherryplankstairs");
		}
