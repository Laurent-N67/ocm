...
public class GoldtileslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:goldtileslab")
	public static final Block block = null;

	public GoldtileslabBlock(OcmModElements instance) {
		super(instance, 1044);
	}
