...
public class Plantoa3Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:plantoa_3")
	public static final Block block = null;

	public Plantoa3Block(OcmModElements instance) {
		super(instance, 1140);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("plantoa_3"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ocm:plantoa_3"), configuredFeature);
		}
	}
