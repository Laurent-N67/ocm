...
public class DungeonmoussystonebrickBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonmoussystonebrick")
	public static final Block block = null;

	public DungeonmoussystonebrickBlock(OcmModElements instance) {
		super(instance, 1331);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dungeonmoussystonebrick");
		}
