...
public class SheperdinblockBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:sheperdinblock")
	public static final Block block = null;

	public SheperdinblockBlock(OcmModElements instance) {
		super(instance, 539);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("sheperdinblock");
		}
