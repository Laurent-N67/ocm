...
public class UpblocksupportdarkoakBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:upblocksupportdarkoak")
	public static final Block block = null;

	public UpblocksupportdarkoakBlock(OcmModElements instance) {
		super(instance, 774);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("upblocksupportdarkoak");
		}
