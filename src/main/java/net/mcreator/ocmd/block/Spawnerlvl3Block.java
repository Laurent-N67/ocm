...
import net.mcreator.ocmd.procedures.Spawnerlvl3MiseAJourDuTickProcedure;
...
public class Spawnerlvl3Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:spawnerlvl_3")
	public static final Block block = null;

	public Spawnerlvl3Block(OcmModElements instance) {
		super(instance, 869);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			Spawnerlvl3MiseAJourDuTickProcedure.executeProcedure(Stream
