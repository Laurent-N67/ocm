...
public class RubybricksBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:rubybricks")
	public static final Block block = null;

	public RubybricksBlock(OcmModElements instance) {
		super(instance, 2131);
	}
