...
public class IolitewistedBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:iolitewisted")
	public static final Block block = null;

	public IolitewistedBlock(OcmModElements instance) {
		super(instance, 1054);
	}
