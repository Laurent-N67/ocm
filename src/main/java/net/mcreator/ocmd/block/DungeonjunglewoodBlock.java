...
public class DungeonjunglewoodBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonjunglewood")
	public static final Block block = null;

	public DungeonjunglewoodBlock(OcmModElements instance) {
		super(instance, 1353);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("dungeonjunglewood");
		}
