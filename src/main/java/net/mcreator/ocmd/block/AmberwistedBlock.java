...
public class AmberwistedBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:amberwisted")
	public static final Block block = null;

	public AmberwistedBlock(OcmModElements instance) {
		super(instance, 993);
	}
