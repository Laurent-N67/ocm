...
public class IoliteweaverBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ioliteweaver")
	public static final Block block = null;

	public IoliteweaverBlock(OcmModElements instance) {
		super(instance, 1053);
	}
