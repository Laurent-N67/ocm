...
public class StrwoolorgBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:strwoolorg")
	public static final Block block = null;

	public StrwoolorgBlock(OcmModElements instance) {
		super(instance, 417);
	}
