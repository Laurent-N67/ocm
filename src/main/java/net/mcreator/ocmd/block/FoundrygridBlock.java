...
import net.mcreator.ocmd.procedures.FoundrygridMiseAJourDuTickProcedure;
...
public class FoundrygridBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:foundrygrid")
	public static final Block block = null;

	public FoundrygridBlock(OcmModElements instance) {
		super(instance, 2465);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			FoundrygridMiseAJourDuTickProcedure.executeProcedure(Stream
