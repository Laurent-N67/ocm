...
public class BsfwhiteBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:bsfwhite")
	public static final Block block = null;

	public BsfwhiteBlock(OcmModElements instance) {
		super(instance, 668);
	}
