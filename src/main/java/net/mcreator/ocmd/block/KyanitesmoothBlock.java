...
public class KyanitesmoothBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:kyanitesmooth")
	public static final Block block = null;

	public KyanitesmoothBlock(OcmModElements instance) {
		super(instance, 1074);
	}
