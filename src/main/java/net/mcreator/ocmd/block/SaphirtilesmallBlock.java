...
public class SaphirtilesmallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:saphirtilesmall")
	public static final Block block = null;

	public SaphirtilesmallBlock(OcmModElements instance) {
		super(instance, 2148);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("saphirtilesmall");
		}
