...
public class RubywistedBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:rubywisted")
	public static final Block block = null;

	public RubywistedBlock(OcmModElements instance) {
		super(instance, 2139);
	}
