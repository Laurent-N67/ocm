...
public class PlatinetilestairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:platinetilestair")
	public static final Block block = null;

	public PlatinetilestairBlock(OcmModElements instance) {
		super(instance, 2129);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("platinetilestair");
		}
