...
public class PilstoneBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:pilstone")
	public static final Block block = null;

	public PilstoneBlock(OcmModElements instance) {
		super(instance, 492);
	}
