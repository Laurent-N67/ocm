...
public class GlsgrpurplpanBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:glsgrpurplpan")
	public static final Block block = null;

	public GlsgrpurplpanBlock(OcmModElements instance) {
		super(instance, 950);
	}
