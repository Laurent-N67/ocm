...
public class AventurinewallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:aventurinewall")
	public static final Block block = null;

	public AventurinewallBlock(OcmModElements instance) {
		super(instance, 1008);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("aventurinewall");
		}
