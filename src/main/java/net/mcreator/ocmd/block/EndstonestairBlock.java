...
public class EndstonestairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:endstonestair")
	public static final Block block = null;

	public EndstonestairBlock(OcmModElements instance) {
		super(instance, 713);
	}
