...
public class TopazchiselBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:topazchisel")
	public static final Block block = null;

	public TopazchiselBlock(OcmModElements instance) {
		super(instance, 2190);
	}
