...
public class StrwooldgrBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:strwooldgr")
	public static final Block block = null;

	public StrwooldgrBlock(OcmModElements instance) {
		super(instance, 407);
	}
