...
public class IcrsgreenBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:icrsgreen")
	public static final Block block = null;

	public IcrsgreenBlock(OcmModElements instance) {
		super(instance, 527);
	}
