...
public class PlatformbirchBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:platformbirch")
	public static final Block block = null;

	public PlatformbirchBlock(OcmModElements instance) {
		super(instance, 777);
	}
