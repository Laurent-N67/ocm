...
public class RedwoodPlanksBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:redwood_planks")
	public static final Block block = null;

	public RedwoodPlanksBlock(OcmModElements instance) {
		super(instance, 816);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redwood_planks");
		}
