...
public class Plantoa4Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:plantoa_4")
	public static final Block block = null;

	public Plantoa4Block(OcmModElements instance) {
		super(instance, 1141);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("plantoa_4"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ocm:plantoa_4"), configuredFeature);
		}
	}
