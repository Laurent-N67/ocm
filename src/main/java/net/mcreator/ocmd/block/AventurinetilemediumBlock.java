...
public class AventurinetilemediumBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:aventurinetilemedium")
	public static final Block block = null;

	public AventurinetilemediumBlock(OcmModElements instance) {
		super(instance, 1002);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("aventurinetilemedium");
		}
