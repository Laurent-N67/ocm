...
public class EmeraldbrickslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:emeraldbrickslab")
	public static final Block block = null;

	public EmeraldbrickslabBlock(OcmModElements instance) {
		super(instance, 1031);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("emeraldbrickslab");
		}
