...
public class Plantoa2Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:plantoa_2")
	public static final Block block = null;

	public Plantoa2Block(OcmModElements instance) {
		super(instance, 1139);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("plantoa_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ocm:plantoa_2"), configuredFeature);
		}
	}
