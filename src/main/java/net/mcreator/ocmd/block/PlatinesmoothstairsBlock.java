...
public class PlatinesmoothstairsBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:platinesmoothstairs")
	public static final Block block = null;

	public PlatinesmoothstairsBlock(OcmModElements instance) {
		super(instance, 2209);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("platinesmoothstairs");
		}
