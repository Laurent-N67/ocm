...
public class TitanemetalbrickslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:titanemetalbrickslab")
	public static final Block block = null;

	public TitanemetalbrickslabBlock(OcmModElements instance) {
		super(instance, 2179);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("titanemetalbrickslab");
		}
