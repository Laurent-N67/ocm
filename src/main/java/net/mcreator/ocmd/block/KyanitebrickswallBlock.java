...
public class KyanitebrickswallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:kyanitebrickswall")
	public static final Block block = null;

	public KyanitebrickswallBlock(OcmModElements instance) {
		super(instance, 1082);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			...
			setRegistryName("kyanitebrickswall");
		}
