...
public class Chisst4Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:chisst_4")
	public static final Block block = null;

	public Chisst4Block(OcmModElements instance) {
		super(instance, 612);
	}
