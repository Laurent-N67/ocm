...
public class SaphirtilemediumBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:saphirtilemedium")
	public static final Block block = null;

	public SaphirtilemediumBlock(OcmModElements instance) {
		super(instance, 2147);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("saphirtilemedium");
		}
