...
public class GhostplankBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ghostplank")
	public static final Block block = null;

	public GhostplankBlock(OcmModElements instance) {
		super(instance, 2256);
	}
