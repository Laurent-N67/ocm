...
public class Plantoa9Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:plantoa_9")
	public static final Block block = null;

	public Plantoa9Block(OcmModElements instance) {
		super(instance, 1146);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("plantoa_9"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ocm:plantoa_9"), configuredFeature);
		}
	}
