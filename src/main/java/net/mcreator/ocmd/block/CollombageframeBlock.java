...
public class CollombageframeBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:collombageframe")
	public static final Block block = null;

	public CollombageframeBlock(OcmModElements instance) {
		super(instance, 381);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("collombageframe");
		}
