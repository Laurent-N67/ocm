...
public class CitrinepillarBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:citrinepillar")
	public static final Block block = null;

	public CitrinepillarBlock(OcmModElements instance) {
		super(instance, 1011);
	}
