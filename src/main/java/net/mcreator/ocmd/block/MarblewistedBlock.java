...
public class MarblewistedBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:marblewisted")
	public static final Block block = null;

	public MarblewistedBlock(OcmModElements instance) {
		super(instance, 1092);
	}
