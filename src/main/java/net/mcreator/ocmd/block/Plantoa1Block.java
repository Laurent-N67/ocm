...
public class Plantoa1Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:plantoa_1")
	public static final Block block = null;

	public Plantoa1Block(OcmModElements instance) {
		super(instance, 1138);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("plantoa_1"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ocm:plantoa_1"), configuredFeature);
		}
	}
