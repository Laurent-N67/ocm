...
public class Obsidian5Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:obsidian_5")
	public static final Block block = null;

	public Obsidian5Block(OcmModElements instance) {
		super(instance, 703);
	}
