...
public class Collombageline2Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:collombageline_2")
	public static final Block block = null;

	public Collombageline2Block(OcmModElements instance) {
		super(instance, 383);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("collombageline_2");
		}
