...
public class TitanesmoothBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:titanesmooth")
	public static final Block block = null;

	public TitanesmoothBlock(OcmModElements instance) {
		super(instance, 2180);
	}
