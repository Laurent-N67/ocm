...
public class Chisst3Block extends OcmModElements.ModElement {
	@ObjectHolder("ocm:chisst_3")
	public static final Block block = null;

	public Chisst3Block(OcmModElements instance) {
		super(instance, 581);
	}
