...
public class CopperplankslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:copperplankslab")
	public static final Block block = null;

	public CopperplankslabBlock(OcmModElements instance) {
		super(instance, 2246);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("copperplankslab");
		}
