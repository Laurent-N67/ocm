...
public class BlumplankfenceBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:blumplankfence")
	public static final Block block = null;

	public BlumplankfenceBlock(OcmModElements instance) {
		super(instance, 2235);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("blumplankfence");
		}
