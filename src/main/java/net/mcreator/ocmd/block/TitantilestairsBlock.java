...
public class TitantilestairsBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:titantilestairs")
	public static final Block block = null;

	public TitantilestairsBlock(OcmModElements instance) {
		super(instance, 2184);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("titantilestairs");
		}
