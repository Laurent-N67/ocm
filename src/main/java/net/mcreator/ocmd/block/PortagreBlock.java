...
public class PortagreBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:portagre")
	public static final Block block = null;

	public PortagreBlock(OcmModElements instance) {
		super(instance, 643);
	}
