...
public class SmalljunglestoolBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:smalljunglestool")
	public static final Block block = null;

	public SmalljunglestoolBlock(OcmModElements instance) {
		super(instance, 860);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("smalljunglestool");
		}
