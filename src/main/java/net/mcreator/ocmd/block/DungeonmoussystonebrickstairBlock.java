...
public class DungeonmoussystonebrickstairBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:dungeonmoussystonebrickstair")
	public static final Block block = null;

	public DungeonmoussystonebrickstairBlock(OcmModElements instance) {
		super(instance, 1333);
	}
		...
		public CustomBlock() {
			super(() -> new Block(
					Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 0))
							.getDefaultState(),
					Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(-1, 3600000).setLightLevel(s -> 0));
			setRegistryName("dungeonmoussystonebrickstair");
		}
