...
public class PeridotbrickslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:peridotbrickslab")
	public static final Block block = null;

	public PeridotbrickslabBlock(OcmModElements instance) {
		super(instance, 1129);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("peridotbrickslab");
		}
