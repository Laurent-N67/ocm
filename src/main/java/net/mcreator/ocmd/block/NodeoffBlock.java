...
import net.mcreator.ocmd.procedures.NodeoffRedstoneAllumeeProcedure;
...
public class NodeoffBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:nodeoff")
	public static final Block block = null;

	public NodeoffBlock(OcmModElements instance) {
		super(instance, 828);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				...
				NodeoffRedstoneAllumeeProcedure.executeProcedure(Stream
