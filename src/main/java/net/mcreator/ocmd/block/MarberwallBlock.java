...
public class MarberwallBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:marberwall")
	public static final Block block = null;

	public MarberwallBlock(OcmModElements instance) {
		super(instance, 2212);
	}
