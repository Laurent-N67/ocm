...
public class GhostplankslabBlock extends OcmModElements.ModElement {
	@ObjectHolder("ocm:ghostplankslab")
	public static final Block block = null;

	public GhostplankslabBlock(OcmModElements instance) {
		super(instance, 2258);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("ghostplankslab");
		}
