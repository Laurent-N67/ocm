...
import net.mcreator.ocmd.gui.Bag3GuiWindow;
import net.mcreator.ocmd.gui.Bag3Gui;
...
public class Bagpacklv3Item extends OcmModElements.ModElement {
	@ObjectHolder("ocm:bagpacklv_3")
	public static final Item block = null;

	public Bagpacklv3Item(OcmModElements instance) {
		super(instance, 212);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof Bag3GuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Uncommon Bagpack");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new Bag3Gui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
