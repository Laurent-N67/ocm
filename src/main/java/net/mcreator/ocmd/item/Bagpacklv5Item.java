...
import net.mcreator.ocmd.gui.Bag5GuiWindow;
import net.mcreator.ocmd.gui.Bag5Gui;
...
public class Bagpacklv5Item extends OcmModElements.ModElement {
	@ObjectHolder("ocm:bagpacklv_5")
	public static final Item block = null;

	public Bagpacklv5Item(OcmModElements instance) {
		super(instance, 214);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof Bag5GuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Legendary Bagpack");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new Bag5Gui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
