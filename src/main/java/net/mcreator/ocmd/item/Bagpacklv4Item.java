...
import net.mcreator.ocmd.gui.Bag4GuiWindow;
import net.mcreator.ocmd.gui.Bag4Gui;
...
public class Bagpacklv4Item extends OcmModElements.ModElement {
	@ObjectHolder("ocm:bagpacklv_4")
	public static final Item block = null;

	public Bagpacklv4Item(OcmModElements instance) {
		super(instance, 213);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof Bag4GuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Rare Bagpack");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new Bag4Gui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
