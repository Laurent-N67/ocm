...
public class SwordqstItem extends OcmModElements.ModElement {
	@ObjectHolder("ocm:swordqst")
	public static final Item block = null;

	public SwordqstItem(OcmModElements instance) {
		super(instance, 1271);
	}
