...
import net.mcreator.ocmd.gui.SmallbagGuiWindow;
import net.mcreator.ocmd.gui.SmallbagGui;
...
public class BagItem extends OcmModElements.ModElement {
	@ObjectHolder("ocm:bag")
	public static final Item block = null;

	public BagItem(OcmModElements instance) {
		super(instance, 136);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof SmallbagGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new SmallbagGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
