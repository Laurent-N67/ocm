...
import net.mcreator.ocmd.gui.Bag2GuiWindow;
import net.mcreator.ocmd.gui.Bag2Gui;
...
public class Bagpacklv2Item extends OcmModElements.ModElement {
	@ObjectHolder("ocm:bagpacklv_2")
	public static final Item block = null;

	public Bagpacklv2Item(OcmModElements instance) {
		super(instance, 211);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof Bag2GuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Standard Bagpack");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new Bag2Gui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
