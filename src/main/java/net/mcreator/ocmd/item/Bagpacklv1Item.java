...
import net.mcreator.ocmd.gui.Bag1GuiWindow;
import net.mcreator.ocmd.gui.Bag1Gui;
...
public class Bagpacklv1Item extends OcmModElements.ModElement {
	@ObjectHolder("ocm:bagpacklv_1")
	public static final Item block = null;

	public Bagpacklv1Item(OcmModElements instance) {
		super(instance, 210);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof Bag1GuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Beginner Bagpack");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new Bag1Gui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
