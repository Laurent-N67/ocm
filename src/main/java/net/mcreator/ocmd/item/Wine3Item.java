...
public class Wine3Item extends OcmModElements.ModElement {
	@ObjectHolder("ocm:wine_3")
	public static final Item block = null;

	public Wine3Item(OcmModElements instance) {
		super(instance, 1181);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			super(new Item.Properties().group(ItemGroup.FOOD).maxStackSize(16).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(4).saturation(0.7f).setAlwaysEdible()

							.build()));
			setRegistryName("wine_3");
		}
