...
public class Wine2Item extends OcmModElements.ModElement {
	@ObjectHolder("ocm:wine_2")
	public static final Item block = null;

	public Wine2Item(OcmModElements instance) {
		super(instance, 1180);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			super(new Item.Properties().group(ItemGroup.FOOD).maxStackSize(16).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(2).saturation(0.5f).setAlwaysEdible()

							.build()));
			setRegistryName("wine_2");
		}
