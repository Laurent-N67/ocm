...
public class LetterqstItem extends OcmModElements.ModElement {
	@ObjectHolder("ocm:letterqst")
	public static final Item block = null;

	public LetterqstItem(OcmModElements instance) {
		super(instance, 1270);
	}
