...
package net.mcreator.ocmd.world.structure;
...
public class AppletreeStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 1000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("ocm", "pommier"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("appletree"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("ocm:appletree"), configuredFeature);
		}
	}
	...
	public static void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("ocm:flatocm").equals(event.getName()))
			biomeCriteria = true;
