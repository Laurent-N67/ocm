...
public class FarmmegapinesBiome extends OcmModElements.ModElement {
	public static Biome biome;

	public FarmmegapinesBiome(OcmModElements instance) {
		super(instance, 1620);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("ocm:farmmegapines"));
			}
		}
	}
