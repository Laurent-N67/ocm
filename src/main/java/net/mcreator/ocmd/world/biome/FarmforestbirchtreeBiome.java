...
public class FarmforestbirchtreeBiome extends OcmModElements.ModElement {
	public static Biome biome;

	public FarmforestbirchtreeBiome(OcmModElements instance) {
		super(instance, 1619);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("ocm:farmforestbirchtree"));
			}
		}
	}
