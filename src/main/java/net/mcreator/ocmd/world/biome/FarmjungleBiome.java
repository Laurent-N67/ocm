...
public class FarmjungleBiome extends OcmModElements.ModElement {
	public static Biome biome;

	public FarmjungleBiome(OcmModElements instance) {
		super(instance, 1617);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("ocm:farmjungle"));
			}
		}
	}
