...
public class FarmmountainBiome extends OcmModElements.ModElement {
	public static Biome biome;

	public FarmmountainBiome(OcmModElements instance) {
		super(instance, 1614);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.ZOMBIE, 10, 4, 4));
				...
				event.getRegistry().register(biome.setRegistryName("ocm:farmmountain"));
			}
		}
	}
