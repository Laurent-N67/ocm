...
public class FarmmesaBiome extends OcmModElements.ModElement {
	public static Biome biome;

	public FarmmesaBiome(OcmModElements instance) {
		super(instance, 1632);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-16737844).setWaterFogColor(329011)
						.withSkyColor(7972607).withFoliageColor(-10924506).withGrassColor(-10461644).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Blocks.CYAN_TERRACOTTA.getDefaultState(),
				...
				event.getRegistry().register(biome.setRegistryName("ocm:farmmesa"));
			}
		}
	}
