...
public class ParadisestoneBiome extends OcmModElements.ModElement {
	public static Biome biome;

	public ParadisestoneBiome(OcmModElements instance) {
		super(instance, 1540);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-14923144).setWaterFogColor(-14923144)
						.withSkyColor(7972607).withFoliageColor(-14190564).withGrassColor(-14190564).build();
				...
				event.getRegistry().register(biome.setRegistryName("ocm:paradisestone"));
			}
		}
	}
