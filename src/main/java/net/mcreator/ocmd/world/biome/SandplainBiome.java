...
public class SandplainBiome extends OcmModElements.ModElement {
	public static Biome biome;

	public SandplainBiome(OcmModElements instance) {
		super(instance, 1557);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("ocm:sandplain"));
			}
		}
	}
