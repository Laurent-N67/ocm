...
public class HellforestBiome extends OcmModElements.ModElement {
	public static Biome biome;

	public HellforestBiome(OcmModElements instance) {
		super(instance, 1626);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("ocm:hellforest"));
			}
		}
	}
