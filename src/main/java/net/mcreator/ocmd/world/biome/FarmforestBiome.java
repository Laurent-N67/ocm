...
public class FarmforestBiome extends OcmModElements.ModElement {
	public static Biome biome;

	public FarmforestBiome(OcmModElements instance) {
		super(instance, 1615);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("ocm:farmforest"));
			}
		}
	}
