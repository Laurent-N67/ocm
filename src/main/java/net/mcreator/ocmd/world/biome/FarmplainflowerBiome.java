...
public class FarmplainflowerBiome extends OcmModElements.ModElement {
	public static Biome biome;

	public FarmplainflowerBiome(OcmModElements instance) {
		super(instance, 1622);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("ocm:farmplainflower"));
			}
		}
	}
