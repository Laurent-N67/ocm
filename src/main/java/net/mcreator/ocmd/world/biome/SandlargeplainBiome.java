...
public class SandlargeplainBiome extends OcmModElements.ModElement {
	public static Biome biome;

	public SandlargeplainBiome(OcmModElements instance) {
		super(instance, 1560);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("ocm:sandlargeplain"));
			}
		}
	}
