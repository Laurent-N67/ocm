...
public class DiggysnowworldBiome extends OcmModElements.ModElement {
	public static Biome biome;

	public DiggysnowworldBiome(OcmModElements instance) {
		super(instance, 2544);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("ocm:diggysnowworld"));
			}
		}
	}
