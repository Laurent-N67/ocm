...
public class HellhighforestBiome extends OcmModElements.ModElement {
	public static Biome biome;

	public HellhighforestBiome(OcmModElements instance) {
		super(instance, 1628);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-9745637).setWaterColor(-12515834).setWaterFogColor(-12515834)
						.withSkyColor(-9745637).withFoliageColor(-1).withGrassColor(-1).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						...
						.withPlacement(Placement.COUNT_EXTRA.configure(new AtSurfaceWithExtraConfig(21, 0.1F, 1))));
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.NONE).category(Biome.Category.NONE).depth(1.2f).scale(2f).temperature(2f)
						.downfall(0f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("ocm:hellhighforest"));
			}
		}
	}
