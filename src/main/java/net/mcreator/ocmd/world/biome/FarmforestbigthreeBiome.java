...
public class FarmforestbigthreeBiome extends OcmModElements.ModElement {
	public static Biome biome;

	public FarmforestbigthreeBiome(OcmModElements instance) {
		super(instance, 1618);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("ocm:farmforestbigthree"));
			}
		}
	}
