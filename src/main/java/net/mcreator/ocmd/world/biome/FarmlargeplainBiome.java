...
public class FarmlargeplainBiome extends OcmModElements.ModElement {
	public static Biome biome;

	public FarmlargeplainBiome(OcmModElements instance) {
		super(instance, 1621);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("ocm:farmlargeplain"));
			}
		}
	}
