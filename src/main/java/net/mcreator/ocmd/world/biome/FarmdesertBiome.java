...
public class FarmdesertBiome extends OcmModElements.ModElement {
	public static Biome biome;

	public FarmdesertBiome(OcmModElements instance) {
		super(instance, 1613);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(TigerEntity.entity, 10, 2, 4));
				...
				event.getRegistry().register(biome.setRegistryName("ocm:farmdesert"));
			}
		}
	}
