...
public class DiggyworlstoneBiome extends OcmModElements.ModElement {
	public static Biome biome;

	public DiggyworlstoneBiome(OcmModElements instance) {
		super(instance, 2537);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("ocm:diggyworlstone"));
			}
		}
	}
